(() => {
  var __webpack_modules__ = {
    ...
    42486: (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      exports.setopts = function(self, pattern, options) {
        ...
        var cwd = process.cwd();
        ownProp(options, "cwd") ? (self.cwd = path.resolve(options.cwd), self.changedCwd = self.cwd !== cwd) : self.cwd = path.resolve(cwd);
        self.root = options.root || path.resolve(self.cwd, "/"), self.root = path.resolve(self.root), 
        self.cwdAbs = isAbsolute(self.cwd) ? self.cwd : makeAbs(self, self.cwd), self.nomount = !!options.nomount, 
        "win32" === process.platform && (self.root = self.root.replace(/\\/g, "/"), self.cwd = self.cwd.replace(/\\/g, "/"), 
        self.cwdAbs = self.cwdAbs.replace(/\\/g, "/"));
        options.nonegate = !0, options.nocomment = !0, options.allowWindowsEscape = !0, 
      ...
      var fs = __webpack_require__(57147), path = __webpack_require__(71017), minimatch = __webpack_require__(51191), isAbsolute = __webpack_require__(71017).isAbsolute, Minimatch = minimatch.Minimatch;
    ...
    96981: (module, __unused_webpack_exports, __webpack_require__) => {
      module.exports = glob;
      var rp = __webpack_require__(94854), minimatch = __webpack_require__(51191), inherits = (minimatch.Minimatch, 
      __webpack_require__(90741)), EE = __webpack_require__(82361).EventEmitter, path = __webpack_require__(71017), assert = __webpack_require__(39491), isAbsolute = __webpack_require__(71017).isAbsolute, globSync = __webpack_require__(81702), common = __webpack_require__(42486), setopts = common.setopts, ownProp = common.ownProp, inflight = __webpack_require__(59956), childrenIgnored = (__webpack_require__(73837), 
    ...
    81702: (module, __unused_webpack_exports, __webpack_require__) => {
      module.exports = globSync, globSync.GlobSync = GlobSync;
      var rp = __webpack_require__(94854), minimatch = __webpack_require__(51191), path = (minimatch.Minimatch, 
      __webpack_require__(96981).Glob, __webpack_require__(73837), __webpack_require__(71017)), assert = __webpack_require__(39491), isAbsolute = __webpack_require__(71017).isAbsolute, common = __webpack_require__(42486), setopts = common.setopts, ownProp = common.ownProp, childrenIgnored = common.childrenIgnored, isIgnored = common.isIgnored;
