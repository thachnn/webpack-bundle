module.exports = function(modules) {
  ...
  var GLOBSTAR = minimatch.GLOBSTAR = Minimatch.GLOBSTAR = {}, expand = __webpack_require__(12), plTypes = {
    "!": {
      open: "(?:(?!(?:",
      close: "))[^/]*?)"
    },
  ...
  module.exports = glob;
  var rp = __webpack_require__(6), minimatch = __webpack_require__(2), inherits = (minimatch.Minimatch, 
  __webpack_require__(15)), EE = __webpack_require__(17).EventEmitter, path = __webpack_require__(0), assert = __webpack_require__(7), isAbsolute = __webpack_require__(4), globSync = __webpack_require__(18), common = __webpack_require__(8), setopts = common.setopts, ownProp = common.ownProp, inflight = __webpack_require__(19), childrenIgnored = (__webpack_require__(3), 
  common.childrenIgnored), isIgnored = common.isIgnored, once = __webpack_require__(10);
  ...
  var fs = __webpack_require__(1), origRealpath = fs.realpath, origRealpathSync = fs.realpathSync, version = process.version, ok = /^v[0-5]\./.test(version), old = __webpack_require__(11);
  ...
  var fs = __webpack_require__(1), path = __webpack_require__(0), minimatch = __webpack_require__(2), isAbsolute = __webpack_require__(4), Minimatch = minimatch.Minimatch;
  ...
  var pathModule = __webpack_require__(0), isWindows = "win32" === process.platform, fs = __webpack_require__(1), DEBUG = process.env.NODE_DEBUG && /fs/.test(process.env.NODE_DEBUG);
  ...
  var concatMap = __webpack_require__(13), balanced = __webpack_require__(14);
  ...
  var rp = __webpack_require__(6), minimatch = __webpack_require__(2), path = (minimatch.Minimatch, 
  __webpack_require__(5).Glob, __webpack_require__(3), __webpack_require__(0)), assert = __webpack_require__(7), isAbsolute = __webpack_require__(4), common = __webpack_require__(8), setopts = common.setopts, ownProp = common.ownProp, childrenIgnored = common.childrenIgnored, isIgnored = common.isIgnored;
  ...
  var wrappy = __webpack_require__(9), reqs = Object.create(null), once = __webpack_require__(10);
  function slice(args) {
