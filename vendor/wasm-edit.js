!function() {
  var __webpack_modules__ = {
    ...
    962: function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.r(__webpack_exports__), __webpack_require__.d(__webpack_exports__, {
        DOUBLE_PRECISION_MANTISSA: function() {
          return DOUBLE_PRECISION_MANTISSA;
        },
        NUMBER_OF_BYTE_F32: function() {
          return NUMBER_OF_BYTE_F32;
        },
        NUMBER_OF_BYTE_F64: function() {
          return NUMBER_OF_BYTE_F64;
        },
        SINGLE_PRECISION_MANTISSA: function() {
    ...
    687: function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      "use strict";
      __webpack_require__.r(__webpack_exports__), __webpack_require__.d(__webpack_exports__, {
        MAX_NUMBER_OF_BYTE_U32: function() {
          return MAX_NUMBER_OF_BYTE_U32;
        },
        MAX_NUMBER_OF_BYTE_U64: function() {
    ...
    182: function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var encoder = __webpack_require__(51);
    },
    391: function(__unused_webpack_module, exports, __webpack_require__) {
      "use strict";
      ...
      var obj, leb = _interopRequireWildcard(__webpack_require__(687)), ieee754 = _interopRequireWildcard(__webpack_require__(962)), utf8 = _interopRequireWildcard(__webpack_require__(182)), _helperWasmBytecode = (obj = __webpack_require__(447)) && obj.__esModule ? obj : {
        default: obj
      }, _index = __webpack_require__(785);
  ...
  !function() {
    ...
    var external_wasm_parser_namespaceObject = require("./wasm-parser"), external_wasm_ast_namespaceObject = require("./wasm-ast"), clone = __webpack_require__(610), encoder = __webpack_require__(391);
    ...
    function shrinkPaddedLEB128(ast, uint8Buffer) {
      return (0, external_wasm_ast_namespaceObject.traverse)(ast, {
        SectionMetadata: function(_ref2) {
          var node = _ref2.node, newu32Encoded = (0, encoder.encodeU32)(node.size.value), newu32EncodedLen = newu32Encoded.length, start = node.size.loc.start.column, end = node.size.loc.end.column, oldu32EncodedLen = end - start;
    ...
    var esm = __webpack_require__(447), leb128_esm = __webpack_require__(687), ieee754_esm = __webpack_require__(962), esm_encoder = __webpack_require__(51);
    ...
    function encodeUTF8Vec(str) {
      return encodeVec(esm_encoder.c(str));
    }
    function encodeLimits(n) {
      var out = [];
    ...
    function applyDelete(ast, uint8Buffer, node) {
      if ((0, external_wasm_ast_namespaceObject.assertHasLoc)(node), "start" === (0, esm.getSectionForNode)(node)) {
        ...
        switch (op.kind) {
         case "update":
          state = function(ast, uint8Buffer, _ref) {
            ...
            var sectionName = (0, esm.getSectionForNode)(newNode), replacementByteArray = encodeNode(newNode);
              ...
              Func: function(_ref3) {
                ...
                if (!0 == (void 0 !== node.body.find((function(n) {
                  ...
                  if (0 !== bodySizeDeltaBytes) {
                    var newValue = node.metadata.bodySize + bodySizeDeltaBytes, newByteArray = (0, encoder.encodeU32)(newValue), start = node.loc.start.column;
          ...
          }(ast, uint8Buffer, [ op.oldNode, op.node ]), sectionName = (0, esm.getSectionForNode)(op.node);
          break;

         case "delete":
          state = applyDelete(ast, uint8Buffer, op.node), sectionName = (0, esm.getSectionForNode)(op.node);
          break;

         case "add":
          state = function(ast, uint8Buffer, node) {
            var body, sectionName = (0, esm.getSectionForNode)(node), sectionMetadata = (0, 
            external_wasm_ast_namespaceObject.getSectionMetadata)(ast, sectionName);
          ...
          }(ast, uint8Buffer, op.node), sectionName = (0, esm.getSectionForNode)(op.node);
          break;
    ...
    function editWithAST(ast, ab, visitors) {
      ...
      return (0, external_wasm_ast_namespaceObject.traverse)(ast, visitors, (function(type, path) {
        nodeBefore = (0, clone.s)(path.node);
      }), (function(type, path) {
    ...
    function addWithAST(ast, ab, newNodes) {
      !function(nodes) {
        ...
        nodes.sort((function(a, b) {
          var sectionA = (0, esm.getSectionForNode)(a), sectionB = (0, esm.getSectionForNode)(b), aId = esm.default.sections[sectionA], bId = esm.default.sections[sectionB];
