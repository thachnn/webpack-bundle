module.exports = function(modules) {
  ...
  var once = __webpack_require__(5), noop = function() {}, eos = function(stream, opts, callback) {
  ...
  var once = __webpack_require__(5), eos = __webpack_require__(2), fs = __webpack_require__(10), noop = function() {}, ancient = /^v?\.0/.test(process.version), isFn = function(fn) {
  ...
  var stream = __webpack_require__(1), eos = __webpack_require__(2), inherits = __webpack_require__(0), shift = __webpack_require__(6), SIGNAL_FLUSH = Buffer.from && Buffer.from !== Uint8Array.from ? Buffer.from([ 0 ]) : new Buffer([ 0 ]), onuncork = function(self, fn) {
  ...
  module.exports.pipe = __webpack_require__(4), module.exports.each = __webpack_require__(11), 
  module.exports.pipeline = __webpack_require__(12), module.exports.duplex = __webpack_require__(7), 
  module.exports.through = __webpack_require__(14), module.exports.concat = __webpack_require__(16), 
  module.exports.finished = __webpack_require__(2), module.exports.from = __webpack_require__(19), 
  module.exports.to = __webpack_require__(20), module.exports.parallel = __webpack_require__(21);
}, function(module, exports) {
  ...
  var eos = __webpack_require__(2), shift = __webpack_require__(6);
  ...
  var pump = __webpack_require__(4), inherits = __webpack_require__(0), Duplexify = __webpack_require__(7), toArray = function(args) {
  ...
  var Transform = __webpack_require__(1).Transform, inherits = __webpack_require__(3).inherits, xtend = __webpack_require__(15);
  ...
  var Writable = __webpack_require__(1).Writable, inherits = __webpack_require__(0), bufferFrom = __webpack_require__(17);
  if ("undefined" == typeof Uint8Array) var U8 = __webpack_require__(18).Uint8Array; else U8 = Uint8Array;
  ...
  !function() {
    ...
    function makeConstructor(bytesPerElement, pack, unpack) {
      ...
      }).prototype = new ArrayBufferView, ctor.prototype.BYTES_PER_ELEMENT = bytesPerElement, 
  ...
  var Readable = __webpack_require__(1).Readable, inherits = __webpack_require__(0);
  ...
  var stream = __webpack_require__(1), inherits = __webpack_require__(0), SIGNAL_FLUSH = Buffer.from && Buffer.from !== Uint8Array.from ? Buffer.from([ 0 ]) : new Buffer([ 0 ]);
  ...
  var Transform = __webpack_require__(1).Transform, inherits = __webpack_require__(0), cyclist = __webpack_require__(22), ParallelTransform = (__webpack_require__(3), 
