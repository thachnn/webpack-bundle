...
const re_safe_regexp = /^[\\/|\0\s\w^$.[\]()]*$/, regexp_is_safe = source => re_safe_regexp.test(source), all_flags = "dgimsuy";
...
function from_char_code(code) {
  return code > 65535 ? (code -= 65536, String.fromCharCode(55296 + (code >> 10)) + String.fromCharCode(code % 1024 + 56320)) : String.fromCharCode(code);
}
...
function tokenizer($TEXT, filename, html5_comments, shebang) {
  ...
  var skip_multiline_comment = with_eof_error("Unterminated multiline comment", (function() {
    ...
    return forward(get_full_char_length(text) + 2), S.comments_before.push(token("comment2", text, !0)), 
...
const EXPECT_DIRECTIVE = /^$|[;{][\s\n]*$/, CODE_LINE_BREAK = 10, CODE_SPACE = 32, r_annotation = /[@#]__(PURE|INLINE|NOINLINE)__/g;
...
function OutputStream(options) {
  ...
  var to_utf8 = options.ascii_only ? function(str, identifier) {
    return options.ecma >= 2015 && (str = str.replace(/[\ud800-\udbff][\udc00-\udfff]/g, (function(ch) {
      return "\\u{" + get_full_char_code(ch, 0).toString(16) + "}";
...
!function() {
  ...
  DEFPRINT(AST_RegExp, (function(self, output) {
    ...
    source = regexp_source_fix(source), flags = flags ? sort_regexp_flags(flags) : "", 
    source = source.replace(r_slash_script, slash_script_replace), output.print(output.to_utf8(`/${source}/${flags}`));
...
const MASK_EXPORT_DONT_MANGLE = 1, MASK_EXPORT_WANT_MANGLE = 2;
...
SymbolDef.next_id = 1, AST_Scope.DEFMETHOD("figure_out_scope", (function(options, {parent_scope: parent_scope = null, toplevel: toplevel = this} = {}) {
...
const UNUSED = 1, TRUTHY = 2, FALSY = 4, UNDEFINED = 8, INLINED = 16, WRITE_ONLY = 32, SQUEEZED = 256, OPTIMIZED = 512, TOP = 1024, CLEAR_BETWEEN_PASSES = 1792, has_flag = (node, flag) => node.flags & flag, set_flag = (node, flag) => {
  node.flags |= flag;
...
def_optimize(AST_Node, (function(self) {
  ...
  const self = this, reduce_vars = compressor.option("reduce_vars"), preparation = new TreeWalker((function(node, descend) {
    if (clear_flag(node, 1792), reduce_vars) return compressor.top_retain && node instanceof AST_Defun && preparation.parent() === self && set_flag(node, TOP), 
...
!function(def_may_throw_on_access) {
  ...
  def_is_string(AST_Node, return_false), def_is_string(AST_String, return_true), def_is_string(AST_TemplateString, return_true), 
...
def_optimize(AST_Binary, (function(self, compressor) {
  ...
  if (compressor.option("reduce_vars") && is_lhs(self, parent) !== self) {
    ...
    if (single_use && (fixed instanceof AST_Lambda || fixed instanceof AST_Class)) if (retain_top_func(fixed, compressor)) single_use = !1; else if (def.scope !== self.scope && (1 == def.escaped || has_flag(fixed, 16) || within_array_or_object_literal(compressor))) single_use = !1; else if (recursive_ref(compressor, def)) single_use = !1; else if ((def.scope !== self.scope || def.orig[0] instanceof AST_SymbolFunarg) && "f" == (single_use = fixed.is_constant_expression(self.scope))) {
...
def_optimize(AST_Assign, (function(self, compressor) {
  ...
  if (compressor.option("ecma") >= 2020 && is_nullish_check(condition, alternative, compressor)) return make_node(AST_Binary, self, {
    operator: "??",
    left: alternative,
    right: consequent
  }).optimize(compressor);
  ...
  return optimized !== self ? optimized : inline_array_like_spread(self, compressor, self.elements);
...
function mangle_properties(ast, options) {
  ...
  options.builtins || find_builtins(reserved);
  var cache, cname = -1;
...
function read_source_map(code) {
  ...
  return match ? to_ascii(match[2]) : (AST_Node.warn("inline source map not found"), 
  null);
}
...
function init_cache(cache) {
  cache && ("props" in cache ? cache.props instanceof Map || (cache.props = map_from_object(cache.props)) : cache.props = new Map);
}
...
}(), exports.AST_Accessor = AST_Accessor, exports.AST_Array = AST_Array, exports.AST_Arrow = AST_Arrow, 
exports.AST_Assign = AST_Assign, exports.AST_Atom = AST_Atom, exports.AST_Await = AST_Await, 
exports.AST_Binary = AST_Binary, exports.AST_Block = AST_Block, exports.AST_BlockStatement = AST_BlockStatement, 
exports.AST_Boolean = AST_Boolean, exports.AST_Break = AST_Break, exports.AST_Call = AST_Call, 
exports.AST_Case = AST_Case, exports.AST_Catch = AST_Catch, exports.AST_Class = AST_Class, 
exports.AST_ClassExpression = AST_ClassExpression, exports.AST_ConciseMethod = AST_ConciseMethod, 
exports.AST_Conditional = AST_Conditional, exports.AST_Const = AST_Const, exports.AST_Constant = AST_Constant, 
exports.AST_Continue = AST_Continue, exports.AST_DWLoop = AST_DWLoop, exports.AST_Debugger = AST_Debugger, 
exports.AST_DefClass = AST_DefClass, exports.AST_Default = AST_Default, exports.AST_DefaultAssign = AST_DefaultAssign, 
exports.AST_Definitions = AST_Definitions, exports.AST_Defun = AST_Defun, exports.AST_Destructuring = AST_Destructuring, 
exports.AST_Directive = AST_Directive, exports.AST_Do = AST_Do, exports.AST_Dot = AST_Dot, 
exports.AST_EmptyStatement = AST_EmptyStatement, exports.AST_Exit = AST_Exit, exports.AST_Expansion = AST_Expansion, 
exports.AST_Export = AST_Export, exports.AST_False = AST_False, exports.AST_Finally = AST_Finally, 
exports.AST_For = AST_For, exports.AST_ForIn = AST_ForIn, exports.AST_ForOf = AST_ForOf, 
exports.AST_Function = AST_Function, exports.AST_Hole = AST_Hole, exports.AST_If = AST_If, 
exports.AST_Import = AST_Import, exports.AST_Infinity = AST_Infinity, exports.AST_IterationStatement = AST_IterationStatement, 
exports.AST_Jump = AST_Jump, exports.AST_Label = AST_Label, exports.AST_LabelRef = AST_LabelRef, 
exports.AST_LabeledStatement = AST_LabeledStatement, exports.AST_Lambda = AST_Lambda, 
exports.AST_Let = AST_Let, exports.AST_LoopControl = AST_LoopControl, exports.AST_NaN = AST_NaN, 
exports.AST_NameMapping = AST_NameMapping, exports.AST_New = AST_New, exports.AST_NewTarget = AST_NewTarget, 
exports.AST_Node = AST_Node, exports.AST_Null = AST_Null, exports.AST_Number = AST_Number, 
exports.AST_Object = AST_Object, exports.AST_ObjectGetter = AST_ObjectGetter, exports.AST_ObjectKeyVal = AST_ObjectKeyVal, 
exports.AST_ObjectProperty = AST_ObjectProperty, exports.AST_ObjectSetter = AST_ObjectSetter, 
exports.AST_PrefixedTemplateString = AST_PrefixedTemplateString, exports.AST_PropAccess = AST_PropAccess, 
exports.AST_RegExp = AST_RegExp, exports.AST_Return = AST_Return, exports.AST_Scope = AST_Scope, 
exports.AST_Sequence = AST_Sequence, exports.AST_SimpleStatement = AST_SimpleStatement, 
exports.AST_Statement = AST_Statement, exports.AST_StatementWithBody = AST_StatementWithBody, 
exports.AST_String = AST_String, exports.AST_Sub = AST_Sub, exports.AST_Super = AST_Super, 
exports.AST_Switch = AST_Switch, exports.AST_SwitchBranch = AST_SwitchBranch, exports.AST_Symbol = AST_Symbol, 
exports.AST_SymbolBlockDeclaration = AST_SymbolBlockDeclaration, exports.AST_SymbolCatch = AST_SymbolCatch, 
exports.AST_SymbolClass = AST_SymbolClass, exports.AST_SymbolConst = AST_SymbolConst, 
exports.AST_SymbolDeclaration = AST_SymbolDeclaration, exports.AST_SymbolDefClass = AST_SymbolDefClass, 
exports.AST_SymbolDefun = AST_SymbolDefun, exports.AST_SymbolExport = AST_SymbolExport, 
exports.AST_SymbolExportForeign = AST_SymbolExportForeign, exports.AST_SymbolFunarg = AST_SymbolFunarg, 
exports.AST_SymbolImport = AST_SymbolImport, exports.AST_SymbolImportForeign = AST_SymbolImportForeign, 
exports.AST_SymbolLambda = AST_SymbolLambda, exports.AST_SymbolLet = AST_SymbolLet, 
exports.AST_SymbolMethod = AST_SymbolMethod, exports.AST_SymbolRef = AST_SymbolRef, 
exports.AST_SymbolVar = AST_SymbolVar, exports.AST_TemplateSegment = AST_TemplateSegment, 
exports.AST_TemplateString = AST_TemplateString, exports.AST_This = AST_This, exports.AST_Throw = AST_Throw, 
exports.AST_Token = AST_Token, exports.AST_Toplevel = AST_Toplevel, exports.AST_True = AST_True, 
exports.AST_Try = AST_Try, exports.AST_Unary = AST_Unary, exports.AST_UnaryPostfix = AST_UnaryPostfix, 
exports.AST_UnaryPrefix = AST_UnaryPrefix, exports.AST_Undefined = AST_Undefined, 
exports.AST_Var = AST_Var, exports.AST_VarDef = AST_VarDef, exports.AST_While = AST_While, 
exports.AST_With = AST_With, exports.AST_Yield = AST_Yield, exports.Compressor = Compressor, 
exports.OutputStream = OutputStream, exports.TreeTransformer = TreeTransformer, 
exports.TreeWalker = TreeWalker, exports._INLINE = _INLINE, exports._JS_Parse_Error = JS_Parse_Error, 
exports._NOINLINE = _NOINLINE, exports._PURE = _PURE, exports._has_annotation = has_annotation, 
exports._tokenizer = tokenizer, exports.base54 = base54, exports.default_options = default_options, 
exports.defaults = defaults, exports.mangle_properties = mangle_properties, exports.minify = minify, 
exports.parse = parse, exports.push_uniq = push_uniq, exports.reserve_quoted_keys = reserve_quoted_keys, 
exports.string_template = string_template, exports.to_ascii = to_ascii;
