!function(root, factory) {
  ...
  var __webpack_modules__ = {
    ...
    827: (__unused_webpack_module, exports, __webpack_require__) => {
      const base64 = __webpack_require__(381);
    ...
    832: (__unused_webpack_module, exports) => {
    ...
    571: (__unused_webpack_module, exports, __webpack_require__) => {
    ...
    260: (__unused_webpack_module, exports, __webpack_require__) => {
      const util = __webpack_require__(13), binarySearch = __webpack_require__(832), ArraySet = __webpack_require__(676).I, readWasm = (__webpack_require__(827), 
      __webpack_require__(478)), wasm = __webpack_require__(697), INTERNAL = Symbol("smcInternal");
    ...
    498: (__unused_webpack_module, exports, __webpack_require__) => {
      const base64VLQ = __webpack_require__(827), util = __webpack_require__(13), ArraySet = __webpack_require__(676).I, MappingList = __webpack_require__(571).H;
    ...
    602: (__unused_webpack_module, exports, __webpack_require__) => {
      const SourceMapGenerator = __webpack_require__(498).SourceMapGenerator, util = __webpack_require__(13), REGEX_NEWLINE = /(\r?\n)/, isSourceNode = "$$$isSourceNode$$$";
      class SourceNode {
        ...
        static fromStringWithSourceMap(aGeneratedCode, aSourceMapConsumer, aRelativePath) {
          ...
          return aSourceMapConsumer.eachMapping((function(mapping) {
            if (null !== lastMapping) {
              if (!(lastGeneratedLine < mapping.generatedLine)) {
                ...
                mapping.generatedColumn, addMappingWithCode(lastMapping, code), void mapping;
              }
              addMappingWithCode(lastMapping, shiftNextLine()), 0;
            }
            for (;lastGeneratedLine < mapping.generatedLine; ) node.add(shiftNextLine());
            lastGeneratedColumn < mapping.generatedColumn && (remainingLines[remainingLinesIndex] || "", 
            ...
            mapping.generatedColumn), mapping;
          ...
          node.add(remainingLines.splice(remainingLinesIndex).join(""))), aSourceMapConsumer.sources.forEach((function(sourceFile) {
            const content = aSourceMapConsumer.sourceContentFor(sourceFile);
            null != content && (null != aRelativePath && util.join(aRelativePath, sourceFile), 
        ...
        walk(aFn) {
          let chunk;
          for (let i = 0, len = this.children.length; i < len; i++) this.children[i], chunk[isSourceNode] ? chunk.walk(aFn) : "" !== chunk && aFn(chunk, {
            source: this.source,
            line: this.line,
            column: this.column,
            name: this.name
        ...
        join(aSep) {
          ...
          if (len > 0) {
            for ([], 0; i < len - 1; i++) newChildren.push(this.children[i]), newChildren.push(aSep);
        ...
        toStringWithSourceMap(aArgs) {
          ...
          return this.walk((function(chunk, original) {
            generated.code += chunk, null !== original.source && null !== original.line && null !== original.column ? (lastOriginalSource === original.source && lastOriginalLine === original.line && lastOriginalColumn === original.column && lastOriginalName === original.name || map.addMapping({
              ...
              name: original.name
            }), original.source, original.line, original.column, original.name, !0) : sourceMappingActive && (map.addMapping({
              generated: {
                line: generated.line,
                column: generated.column
              }
            ...
            generated.column = 0, idx + 1 === length ? (null, !1) : sourceMappingActive && map.addMapping({
              source: original.source,
              original: {
                line: original.line,
                column: original.column
    ...
    697: (module, __unused_webpack_exports, __webpack_require__) => {
      const readWasm = __webpack_require__(478);
      function Mapping() {
    ...
    217: (__unused_webpack_module, exports, __webpack_require__) => {
      exports.SourceMapGenerator = __webpack_require__(498).SourceMapGenerator, exports.SourceMapConsumer = __webpack_require__(260).SourceMapConsumer, 
    ...
    230: (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
      "use strict";
      ...
      }, keywordRelationalOperator = /^in(stanceof)?$/, nonASCIIidentifierStart = new RegExp("[" + nonASCIIidentifierStartChars + "]"), nonASCIIidentifier = new RegExp("[" + nonASCIIidentifierStartChars + "‌‍·̀-ͯ·҃-֑҇-ׇֽֿׁׂׅׄؐ-ًؚ-٩ٰۖ-ۜ۟-۪ۤۧۨ-ۭ۰-۹ܑܰ-݊ަ-ް߀-߉߫-߽߳ࠖ-࠙ࠛ-ࠣࠥ-ࠧࠩ-࡙࠭-࡛࢘-࢟࣊-ࣣ࣡-ःऺ-़ा-ॏ॑-ॗॢॣ०-९ঁ-ঃ়া-ৄেৈো-্ৗৢৣ০-৯৾ਁ-ਃ਼ਾ-ੂੇੈੋ-੍ੑ੦-ੱੵઁ-ઃ઼ા-ૅે-ૉો-્ૢૣ૦-૯ૺ-૿ଁ-ଃ଼ା-ୄେୈୋ-୍୕-ୗୢୣ୦-୯ஂா-ூெ-ைொ-்ௗ௦-௯ఀ-ఄ఼ా-ౄె-ైొ-్ౕౖౢౣ౦-౯ಁ-ಃ಼ಾ-ೄೆ-ೈೊ-್ೕೖೢೣ೦-೯ഀ-ഃ഻഼ാ-ൄെ-ൈൊ-്ൗൢൣ൦-൯ඁ-ඃ්ා-ුූෘ-ෟ෦-෯ෲෳัิ-ฺ็-๎๐-๙ັິ-ຼ່-ໍ໐-໙༘༙༠-༩༹༵༷༾༿ཱ-྄྆྇ྍ-ྗྙ-ྼ࿆ါ-ှ၀-၉ၖ-ၙၞ-ၠၢ-ၤၧ-ၭၱ-ၴႂ-ႍႏ-ႝ፝-፟፩-፱ᜒ-᜕ᜲ-᜴ᝒᝓᝲᝳ឴-៓៝០-៩᠋-᠍᠏-᠙ᢩᤠ-ᤫᤰ-᤻᥆-᥏᧐-᧚ᨗ-ᨛᩕ-ᩞ᩠-᩿᩼-᪉᪐-᪙᪰-᪽ᪿ-ᫎᬀ-ᬄ᬴-᭄᭐-᭙᭫-᭳ᮀ-ᮂᮡ-ᮭ᮰-᮹᯦-᯳ᰤ-᰷᱀-᱉᱐-᱙᳐-᳔᳒-᳨᳭᳴᳷-᳹᷀-᷿‿⁀⁔⃐-⃥⃜⃡-⃰⳯-⵿⳱ⷠ-〪ⷿ-゙゚〯꘠-꘩꙯ꙴ-꙽ꚞꚟ꛰꛱ꠂ꠆ꠋꠣ-ꠧ꠬ꢀꢁꢴ-ꣅ꣐-꣙꣠-꣱ꣿ-꤉ꤦ-꤭ꥇ-꥓ꦀ-ꦃ꦳-꧀꧐-꧙ꧥ꧰-꧹ꨩ-ꨶꩃꩌꩍ꩐-꩙ꩻ-ꩽꪰꪲ-ꪴꪷꪸꪾ꪿꫁ꫫ-ꫯꫵ꫶ꯣ-ꯪ꯬꯭꯰-꯹ﬞ︀-️︠-︯︳︴﹍-﹏０-９＿]");
      ...
      var Parser = function(options, input, startPos) {
        ...
        this.scopeStack = [], this.enterScope(1), this.regexpState = null, this.privateNameStack = [];
      }, prototypeAccessors = {
        inFunction: {
          configurable: !0
        },
      ...
      pp$8.parseTryStatement = function(node) {
        if (this.next(), node.block = this.parseBlock(), node.handler = null, this.type === types$1._catch) {
          ...
          if (this.next(), this.eat(types$1.parenL)) {
            ...
            this.enterScope(simple ? 32 : 0), this.checkLValPattern(clause.param, simple ? 4 : 2), 
      ...
      pp$8.parseFunction = function(node, statement, allowExpressionBody, isAsync, forInit) {
        ...
        statement & FUNC_STATEMENT && (node.id = 4 & statement && this.type !== types$1.name ? null : this.parseIdent(), 
        !node.id || statement & FUNC_HANGING_STATEMENT || this.checkLValSimple(node.id, this.strict || node.generator || node.async ? this.treatFunctionsAsVar ? 1 : 2 : 3));
        ...
        this.type === types$1.name ? (node.id = this.parseIdent(), isStatement && this.checkLValSimple(node.id, 2, !1)) : (!0 === isStatement && this.unexpected(), 
        node.id = null);
        ...
        if (this.type === types$1.name) {
          var node = this.startNode();
          if (node.local = this.parseIdent(), this.checkLValSimple(node.local, 2), nodes.push(this.finishNode(node, "ImportDefaultSpecifier")), 
          !this.eat(types$1.comma)) return nodes;
        }
        if (this.type === types$1.star) {
          var node$1 = this.startNode();
          return this.next(), this.expectContextual("as"), node$1.local = this.parseIdent(), 
          this.checkLValSimple(node$1.local, 2), nodes.push(this.finishNode(node$1, "ImportNamespaceSpecifier")), 
          nodes;
        }
        for (this.expect(types$1.braceL); !this.eat(types$1.braceR); ) {
          if (first) first = !1; else if (this.expect(types$1.comma), this.afterTrailingComma(types$1.braceR)) break;
          ...
          node$2.local = node$2.imported), this.checkLValSimple(node$2.local, 2), nodes.push(this.finishNode(node$2, "ImportSpecifier"));
        }
        return nodes;
      ...
      pp$7.toAssignable = function(node, isBinding, refDestructuringErrors) {
        ...
        switch (expr.type) {
         case "Identifier":
          ...
          isBind && (2 === bindingType && "let" === expr.name && this.raiseRecoverable(expr.start, "let is disallowed as a lexically bound name"), 
          checkClashes && (hasOwn(checkClashes, expr.name) && this.raiseRecoverable(expr.start, "Argument name clash"), 
          checkClashes[expr.name] = !0), 5 !== bindingType && this.declareName(expr.name, bindingType, expr.start));
          break;
      ...
      pp$5.parseNew = function() {
        ...
        this.checkParams(node, !1); else {
          ...
          this.strict && node.id && this.checkLValSimple(node.id, 5), node.body = this.parseBlock(!1, void 0, useStrict && !oldStrict), 
  ...
  return (() => {
    ...
    __webpack_require__.r(ast_namespaceObject), __webpack_require__.d(ast_namespaceObject, {
    ...
    function tokenizer($TEXT, filename, html5_comments, shebang) {
      ...
      function token(type, value, is_comment) {
        ...
        "punc" != type || "." != value && "?." != value ? is_comment || (prev_was_dot = !1) : prev_was_dot = !0;
        const line = S.tokline, col = S.tokcol, pos = S.tokpos, nlb = S.newline_before, file = filename;
        let comments_before = [], comments_after = [];
        is_comment || (comments_before = S.comments_before, comments_after = S.comments_before = []), 
        S.newline_before = !1;
      ...
      function read_num(prefix) {
        ...
        if (prefix && (num = prefix + num), LATEST_RAW = num, RE_OCT_NUMBER.test(num) && next_token.has_directive("use strict") && parse_error("Legacy octal literals are not allowed in strict mode"), 
      ...
      var read_string = with_eof_error("Unterminated string constant", (function() {
        ...
        for (next(!0, !0); "`" != (ch = next(!0, !0)); ) {
          ...
          S.brace_counter++, tok = token(begin ? "template_head" : "template_substitution", content), 
          LATEST_RAW = raw, LATEST_TEMPLATE_END = !1, tok;
          if (raw += ch, "\\" == ch) {
            var tmp = S.pos;
        ...
        return S.template_braces.pop(), tok = token(begin ? "template_head" : "template_substitution", content), 
        LATEST_RAW = raw, LATEST_TEMPLATE_END = !0, tok;
      }));
      ...
      var skip_multiline_comment = with_eof_error("Unterminated multiline comment", (function() {
        ...
        if ("\\" === (ch = peek())) is_identifier_start(ch = read_escaped_identifier_char()) || parse_error("First identifier char is an invalid identifier char"); else {
        ...
        return RESERVED_WORDS.has(name_str) && escaped && parse_error("Escaped characters are not allowed in keywords"), 
        name_str;
    ...
    var UNARY_PREFIX = makePredicate([ "typeof", "void", "delete", "--", "++", "!", "~", "-", "+" ]), UNARY_POSTFIX = makePredicate([ "--", "++" ]), ASSIGNMENT = makePredicate([ "=", "+=", "-=", "??=", "&&=", "||=", "/=", "*=", "**=", "%=", ">>=", "<<=", ">>>=", "|=", "^=", "&=" ]), LOGICAL_ASSIGNMENT = makePredicate([ "??=", "&&=", "||=" ]), PRECEDENCE = function(a, ret) {
    ...
    function parse($TEXT, options) {
          ...
          switch (S.token.value) {
           ...
           case "for":
            return next(), function() {
              ...
              "name" == await_tok.type && "await" == await_tok.value ? (can_await() || token_error(await_tok, for_await_error), 
              next()) : await_tok = !1;
              expect("(");
              var init = null;
              if (is("punc", ";")) await_tok && token_error(await_tok, for_await_error); else {
                ...
                next(), is_in ? for_in(init) : for_of(init, !!await_tok);
              }
           ...
           case "class":
            ...
            is_if_body && croak("classes are not allowed as the body of an if"), class_(AST_DefClass, is_export_default);
      ...
      function labeled_statement() {
        ...
        "await" === label.name && S.in_async === S.in_function && token_error(S.prev, "await cannot be used as label inside async function"), 
      ...
      function if_() {
        ...
        return is("keyword", "else") && (next(), belse = statement(!1, !1, !0)), new AST_If({
          condition: cond,
          body,
          alternative: belse
        });
      ...
      function to_fun_args(ex, default_seen_above) {
        ...
        }), default_seen_above) : ex instanceof AST_ObjectKeyVal ? (ex.value = to_fun_args(ex.value), 
        insert_default(ex, default_seen_above)) : ex instanceof AST_Hole ? ex : ex instanceof AST_Destructuring ? (ex.names = ex.names.map((name => to_fun_args(name))), 
        ...
        }), default_seen_above) : ex instanceof AST_Assign ? insert_default(to_fun_args(ex.left, ex.right), default_seen_above) : ex instanceof AST_DefaultAssign ? (ex.left = to_fun_args(ex.left), 
      ...
      var expr_atom = function(allow_calls, allow_arrows) {
        ...
        if (is("operator", "import")) return function() {
          var start = S.token;
          return expect_token("operator", "import"), expect_token("punc", "."), expect_token("name", "meta"), 
          subscripts(new AST_ImportMeta({
            start,
            end: prev()
          }), !1);
        }();
          ...
          switch (S.token.value) {
           case "(":
            ...
            var exprs = function(allow_arrows, maybe_sequence) {
              ...
              }))) : a.push(expression()), is("punc", ")") || (expect(","), is("punc", ")") && (trailing_comma = prev(), 
              maybe_sequence && (invalid_sequence = trailing_comma)));
      ...
      function template_string() {
        ...
        })); !LATEST_TEMPLATE_END; ) next(), handle_regexp(), segments.push(expression(!0)), 
      ...
      function class_(KindOfClass, is_export_default) {
        ...
        KindOfClass !== AST_DefClass || class_name || (is_export_default ? KindOfClass = AST_ClassExpression : unexpected()), 
        "extends" == S.token.value && (next(), extends_ = expression(!0)), expect("{"); is("punc", ";"); ) next();
      ...
      function concise_method_or_getset(name, start, is_class) {
        ...
        is_class && "static" === name && is_not_method_start() && (is_static = !0, name = as_property_name()), 
        "async" === name && is_not_method_start() && (is_async = !0, name = as_property_name()), 
        "operator" === prev().type && "*" === prev().value && (is_generator = !0, name = as_property_name()), 
        "get" !== name && "set" !== name || !is_not_method_start() || (accessor_type = name, 
        name = as_property_name()), "privatename" === prev().type && (is_private = !0);
        const property_token = prev();
        if (null != accessor_type) {
          if (is_private) {
            return new ("get" === accessor_type ? AST_PrivateGetter : AST_PrivateSetter)({
              start,
              static: is_static,
        ...
        if (is("punc", "(")) {
          ...
          return new (is_private ? AST_PrivateMethod : AST_ConciseMethod)({
            start,
            static: is_static,
            is_generator,
            async: is_async,
      ...
      function export_statement() {
        ...
        return is("punc", "{") || is_default && (is("keyword", "class") || is("keyword", "function")) && is_token(peek(), "punc") ? (exported_value = expression(!1), 
        semicolon()) : (node = statement(is_default)) instanceof AST_Definitions && is_default ? unexpected(node.start) : node instanceof AST_Definitions || node instanceof AST_Defun || node instanceof AST_DefClass ? exported_definition = node : node instanceof AST_ClassExpression || node instanceof AST_Function ? exported_value = node : node instanceof AST_SimpleStatement ? exported_value = node.body : unexpected(node.start), 
        new AST_Export({
          start,
          is_default,
          exported_value,
      ...
      function as_name() {
        var tmp = S.token;
        return "name" != tmp.type && "privatename" != tmp.type && unexpected(), next(), 
        tmp.value;
      }
      ...
      var maybe_unary = function(allow_calls, allow_arrows) {
        var start = S.token;
        if ("name" == start.type && "await" == start.value && can_await()) return next(), 
        can_await() || croak("Unexpected await expression outside async function", S.prev.line, S.prev.col, S.prev.pos), 
        new AST_Await({
          start: prev(),
          end: S.token,
    ...
    class AST_Token {
      constructor(type, value, line, col, pos, nlb, comments_before, comments_after, file) {
        this.flags = nlb ? 1 : 0, this.type = type, this.value = value, this.line = line, 
        this.col = col, this.pos = pos, this.comments_before = comments_before, this.comments_after = comments_after, 
        this.file = file, Object.seal(this);
      }
      get nlb() {
        return has_tok_flag(this, 1);
      }
      set nlb(new_nlb) {
        set_tok_flag(this, 1, new_nlb);
      }
      get quote() {
        return has_tok_flag(this, 4) ? has_tok_flag(this, 2) ? "'" : '"' : "";
      }
      set quote(quote_type) {
        set_tok_flag(this, 2, "'" === quote_type), set_tok_flag(this, 4, !!quote_type);
      }
    }
    ...
    var AST_Block = DEFNODE("Block", "body block_scope", {
      ...
      clone: function(deep, toplevel) {
        ...
        }) : (this.variables && (node.variables = new Map(this.variables)), this.enclosed && (node.enclosed = this.enclosed.slice()), 
        this._block_scope && (node._block_scope = this._block_scope)), node;
      },
      pinned: function() {
    ...
    def_transform(AST_Node, noop), def_transform(AST_LabeledStatement, (function(self, tw) {
      ...
      var MOZ_TO_ME = {
        ...
        PropertyDefinition: function(M) {
          let key;
          if (M.computed) key = from_moz(M.key); else {
            if ("Identifier" !== M.key.type) throw new Error("Non-Identifier key in PropertyDefinition");
            key = from_moz(M.key);
          }
          return new AST_ClassProperty({
            start: my_start_token(M),
      ...
      map("NewExpression", AST_New, "callee>expression, arguments@args"), map("CallExpression", AST_Call, "callee>expression, optional=optional, arguments@args"), 
      ...
      def_to_moz(AST_Export, (function(M) {
        ...
        if (M instanceof AST_ObjectKeyVal ? (kind = "init", computed = !string_or_num) : M instanceof AST_ObjectGetter ? kind = "get" : M instanceof AST_ObjectSetter && (kind = "set"), 
        M instanceof AST_PrivateGetter || M instanceof AST_PrivateSetter) {
          return {
    ...
    class Rope {
      ...
      insertAt(char, index) {
        ...
        index < committed.length ? this.committed = committed.slice(0, index) + char + committed.slice(index) : index === committed.length ? this.committed += char : (index -= committed.length, 
        this.committed += current.slice(0, index) + char, this.current = current.slice(index));
      }
      charAt(index) {
    ...
    function OutputStream(options) {
      ...
      var mapping_token, mapping_name, has_parens = !1, might_need_space = !1, might_need_semicolon = !1, might_add_newline = 0, need_newline_indented = !1, need_space = !1, newline_insert = -1, last = "", mappings = options.source_map && [], do_add_mapping = mappings ? function() {
        mappings.forEach((function(mapping) {
          try {
            ...
            "name" == token.type || "privatename" === token.type ? name = token.value : name instanceof AST_Symbol && (name = "string" === token.type ? token.value : name.name), 
      ...
      function print(str) {
        ...
        might_need_semicolon && (might_need_semicolon = !1, (":" !== prev || "}" !== ch) && (ch && ";}".includes(ch) || ";" === prev) || (options.semicolons || requireSemicolonChars.has(ch) ? (OUTPUT.append(";"), 
        current_col++, current_pos++) : (ensure_line_len(), current_col > 0 && (OUTPUT.append("\n"), 
        current_pos++, current_line++, current_col = 0), /^\s+$/.test(str) && (might_need_semicolon = !0)), 
        options.beautify || (might_need_space = !1))), might_need_space && ((is_identifier_char(prev) && (is_identifier_char(ch) || "\\" == ch) || "/" == ch && ch == prev || ("+" == ch || "-" == ch) && ch == last) && (OUTPUT.append(" "), 
        current_col++, current_pos++), might_need_space = !1), mapping_token && (mappings.push({
          token: mapping_token,
          name: mapping_name,
          line: current_line,
          col: current_col
        }), mapping_token = !1, might_add_newline || do_add_mapping()), OUTPUT.append(str), 
        has_parens = "(" == str[str.length - 1], current_pos += str.length;
        var a = str.split(/\r?\n/), n = a.length - 1;
      ...
      return {
        ...
        print_name: function(name) {
          print(function(name) {
            return name = name.toString(), to_utf8(name, !0);
          }(name));
        },
        print_string: function(str, quote, escape_directive) {
          var encoded = encode_string(str, quote);
          !0 !== escape_directive || encoded.includes("\\") || (EXPECT_DIRECTIVE.test(OUTPUT.toString()) || force_semicolon(), 
    ...
    !function() {
      ...
      function parenthesize_for_noin(node, output, noin) {
        var parens = !1;
        noin && (parens = walk(node, (node => node instanceof AST_Scope && !(node instanceof AST_Arrow) || (node instanceof AST_Binary && "in" == node.operator ? walk_abort : void 0)))), 
        node.print(output, parens);
      }
      function print_property_name(key, quote, output) {
        return output.option("quote_keys") ? output.print_string(key) : "" + +key == key && key >= 0 ? output.option("keep_numbers") ? output.print(key) : output.print(make_num(key)) : (ALL_RESERVED_WORDS.has(key) ? output.option("ie8") : output.option("ecma") < 2015 || output.option("safari10") ? !is_basic_identifier_string(key) : !is_identifier_string(key, !0)) || quote && output.option("keep_quoted_props") ? output.print_string(key, quote) : output.print_name(key);
      }
      AST_Node.DEFMETHOD("print", (function(output, force_parens) {
        ...
        var p = output.parent();
        if (0 === this.args.length && (p instanceof AST_PropAccess || p instanceof AST_Call && p.expression === this || p instanceof AST_PrefixedTemplateString && p.prefix === this)) return !0;
        ...
        if (1 === self.body.length && first_statement instanceof AST_Return) {
          ...
          returned ? left_is_object(returned) ? (output.print("("), returned.print(output), 
          output.print(")")) : returned.print(output) : output.print("{}");
        ...
        var e = self.expression, parens = !(e instanceof AST_Call || e instanceof AST_SymbolRef || e instanceof AST_PropAccess || e instanceof AST_Unary || e instanceof AST_Constant || e instanceof AST_Await || e instanceof AST_Object);
        ...
        output.print("from"), output.space()), self.module_name.print(output), self.assert_clause && (output.print("assert"), 
        self.assert_clause.print(output)), output.semicolon();
        ...
        self.assert_clause && (output.print("assert"), self.assert_clause.print(output)), 
        ...
        self.optional && output.print("?."), output.with_parens((function() {
        ...
        expr.print(output);
        var prop = self.property, print_computed = ALL_RESERVED_WORDS.has(prop) ? output.option("ie8") : !is_identifier_string(prop, output.option("ecma") >= 2015 || output.option("safari10"));
        self.optional && output.print("?."), print_computed ? (output.print("["), output.add_mapping(self.end), 
        output.print_string(prop), output.print("]")) : (expr instanceof AST_Number && expr.getValue() >= 0 && (/[xa-f.)]/i.test(output.last()) || output.print(".")), 
        self.optional || output.print("."), output.add_mapping(self.end), output.print_name(prop));
      })), DEFPRINT(AST_DotHash, (function(self, output) {
        self.expression.print(output);
        var prop = self.property;
        self.optional && output.print("?"), output.print(".#"), output.add_mapping(self.end), 
        output.print_name(prop);
      })), DEFPRINT(AST_Sub, (function(self, output) {
        self.expression.print(output), self.optional && output.print("?."), output.print("["), 
        ...
        allowShortHand && self.value instanceof AST_Symbol && is_identifier_string(self.key, output.option("ecma") >= 2015 || output.option("safari10")) && get_name(self.value) === self.key && !ALL_RESERVED_WORDS.has(self.key) ? print_property_name(self.key, self.quote, output) : allowShortHand && self.value instanceof AST_DefaultAssign && self.value.left instanceof AST_Symbol && is_identifier_string(self.key, output.option("ecma") >= 2015 || output.option("safari10")) && get_name(self.value.left) === self.key ? (print_property_name(self.key, self.quote, output), 
        ...
        self.static && (output.print("static"), output.space()), output.print("#"), print_property_name(self.key.name, self.quote, output), 
        self.value && (output.print("="), self.value.print(output)), output.semicolon();
        ...
        output.space()), self.key instanceof AST_SymbolMethod ? (is_private && output.print("#"), 
        print_property_name(self.key.name, self.quote, output)) : output.with_square((function() {
          self.key.print(output);
        })), self.value._do_print(output, !0);
      })), DEFPRINT(AST_ObjectSetter, (function(self, output) {
        self._print_getter_setter("set", !1, output);
      })), DEFPRINT(AST_ObjectGetter, (function(self, output) {
        self._print_getter_setter("get", !1, output);
      })), DEFPRINT(AST_PrivateSetter, (function(self, output) {
        self._print_getter_setter("set", !0, output);
      })), DEFPRINT(AST_PrivateGetter, (function(self, output) {
        self._print_getter_setter("get", !0, output);
        ...
        self._print_getter_setter(type, !0, output);
      })), DEFPRINT(AST_ConciseMethod, (function(self, output) {
        var type;
        self.is_generator && self.async ? type = "async*" : self.is_generator ? type = "*" : self.async && (type = "async"), 
        self._print_getter_setter(type, !1, output);
        ...
        (output.option("keep_numbers") || output.use_asm) && self.raw ? output.print(self.raw) : output.print(make_num(self.getValue()));
    ...
    AST_PropAccess.prototype.shallow_cmp = pass_through, AST_Chain.prototype.shallow_cmp = pass_through, 
    ...
    class SymbolDef {
      constructor(scope, orig, init) {
        ...
        this.mangled_name = null, this.undeclared = !1, this.id = SymbolDef.next_id++, this.chained = !1, 
        this.direct_access = !1, this.escaped = 0, this.recursive_refs = 0, this.references = [], 
        this.should_replace = void 0, this.single_use = !1, this.fixed = !1, Object.seal(this);
      }
      fixed_value() {
    ...
    SymbolDef.next_id = 1, AST_Scope.DEFMETHOD("figure_out_scope", (function(options, {parent_scope = null, toplevel = this} = {}) {
      ...
      var scope = this.parent_scope = parent_scope, labels = new Map, defun = null, in_destructuring = null, for_scopes = [], tw = new TreeWalker(((node, descend) => {
        ...
        if (node instanceof AST_With) for (var s = scope; s; s = s.parent_scope) s.uses_with = !0; else {
          ...
          node.references = []), node instanceof AST_SymbolLambda) defun.def_function(node, "arguments" == node.name ? void 0 : defun); else if (node instanceof AST_SymbolDefun) {
      ...
      this.variables = new Map, this.uses_with = !1, this.uses_eval = !1, this.parent_scope = parent_scope, 
      this.enclosed = [], this.cname = -1;
    ...
    })), AST_Scope.DEFMETHOD("create_symbol", (function(SymClass, {source, tentative_name, scope, conflict_scopes = [ scope ], init = null} = {}) {
      let symbol_name;
      if (conflict_scopes = function(scopes) {
        ...
        tentative_name = symbol_name = tentative_name.replace(/(?:^[^a-z_$]|[^a-z0-9_$])/gi, "_");
        let i = 0;
        for (;conflict_scopes.find((s => s.conflicting_def_shallow(symbol_name))); ) symbol_name = tentative_name + "$" + i++;
      }
      if (!symbol_name) throw new Error("No symbol name could be generated in create_symbol()");
    ...
    AST_Scope.DEFMETHOD("is_block_scope", (function() {
      ...
      function skip_string(node) {
        node instanceof AST_String ? nth_identifier.consider(node.value, -1) : node instanceof AST_Conditional ? (skip_string(node.consequent), 
    ...
    AST_Node.prototype.size = function(compressor, stack) {
      ...
      return walk_parent(this, ((node, info) => {
        if (size += node._size(info), node instanceof AST_Arrow && node.is_braceless()) return size += node.body[0].value._size(info), 
        !0;
    ...
    function best_of(compressor, ast1, ast2) {
      ...
      }(ast1, ast2) : best_of_expression(ast1, ast2);
    }
    ...
    function maintain_this_binding(parent, orig, val) {
      if (parent instanceof AST_UnaryPrefix && "delete" == parent.operator || parent instanceof AST_Call && parent.expression === orig && (val instanceof AST_PropAccess || val instanceof AST_SymbolRef && "eval" == val.name)) {
    ...
    const pure_prop_access_globals = new Set([ "Number", "String", "Array", "Object", "Function", "Promise" ]), object_methods = [ "constructor", "toString", "valueOf" ], is_pure_native_method = make_nested_lookup({
    ...
    def_is_string(AST_UnaryPrefix, (function() {
      ...
      function to_node(value, orig) {
        if (value instanceof AST_Node) return value instanceof AST_Constant || (value = value.clone(!0)), 
        make_node(value.CTOR, orig, value);
      ...
      AST_Toplevel.DEFMETHOD("resolve_defines", (function(compressor) {
        ...
        if (this.global()) {
          ...
          return HOP(defines, name) ? to_node(defines[name], this) : void 0;
        }
      }));
    }((function(node, func) {
    ...
    AST_Call.DEFMETHOD("is_callee_pure", (function(compressor) {
      if (compressor.option("unsafe")) {
        ...
        if (expr instanceof AST_Dot && is_undeclared_ref(expr.expression) && is_pure_native_fn(expr.expression.name, expr.property)) return !0;
      }
      ...
      let native_obj;
      return expr instanceof AST_Array ? native_obj = "Array" : expr.is_boolean() ? native_obj = "Boolean" : expr.is_number(compressor) ? native_obj = "Number" : expr instanceof AST_RegExp ? native_obj = "RegExp" : expr.is_string(compressor) ? native_obj = "String" : this.may_throw_on_access(compressor) || (native_obj = "Object"), 
      null != native_obj && is_pure_native_method(native_obj, this.property);
    }));
    ...
    def_eval(AST_Binary, (function(compressor, depth) {
      ...
      if (null != left && null != right && identity_comparison.has(this.operator) && has_identity(left) && has_identity(right) && typeof left == typeof right) return this;
      switch (this.operator) {
       case "&&":
        result = left && right;
        break;
    ...
    const global_objs = {
      ...
      Object,
      String
    }, regexp_flags = new Set([ "dotAll", "global", "ignoreCase", "multiline", "sticky", "unicode" ]);
    ...
    function reset_def(compressor, def) {
      ...
      def.recursive_refs = 0, def.references = [], def.single_use = void 0, def.scope.pinned() ? def.fixed = !1 : def.orig[0] instanceof AST_SymbolConst || !compressor.exposed(def) ? def.fixed = def.init : def.fixed = !1;
    }
    ...
    function mark_escaped(tw, d, scope, node, value, level = 0, depth = 1) {
      ...
      if (parent instanceof AST_Assign && ("=" === parent.operator || parent.logical) && node === parent.right || parent instanceof AST_Call && (node !== parent.expression || parent instanceof AST_New) || parent instanceof AST_Exit && node === parent.value && node.scope !== d.scope || parent instanceof AST_VarDef && node === parent.value || parent instanceof AST_Yield && node === parent.value && node.scope !== d.scope) return !(depth > 1) || value && value.is_constant_expression(scope) || (depth = 1), 
    ...
    def_eval(AST_PropAccess, (function(compressor, depth) {
      ...
      return this;
    })), def_eval(AST_New, return_this), def_drop_side_effect_free(AST_Node, return_this), 
    def_drop_side_effect_free(AST_Constant, return_null), def_drop_side_effect_free(AST_This, return_null), 
    ...
    function trim_unreachable_code(compressor, stat, target) {
      walk(stat, (node => node instanceof AST_Var ? (node.remove_initializers(), target.push(node), 
      !0) : node instanceof AST_Defun && (node === stat || !compressor.has_directive("use strict")) ? (target.push(node === stat ? node : make_node(AST_Var, node, {
        definitions: [ make_node(AST_VarDef, node, {
          name: make_node(AST_SymbolVar, node.name, node.name),
          value: null
        }) ]
      })), !0) : node instanceof AST_Export || node instanceof AST_Import ? (target.push(node), 
    ...
    function tighten_body(statements, compressor) {
      ...
      function collapse(statements, compressor) {
        ...
        for (var args, candidates = [], stat_index = statements.length, scanner = new TreeTransformer((function(node) {
          ...
          (stop_after = find_stop(node, 0)) === node && (abort = !0), node);
          ...
          can_replace && !(node instanceof AST_SymbolDeclaration) && lhs.equivalent_to(node) && !function(newScope, lvalues) {
        ...
        function extract_candidates(expr) {
          if (hit_stack.push(expr), expr instanceof AST_Assign) expr.left.has_side_effects(compressor) || expr.right instanceof AST_Chain || candidates.push(hit_stack.slice()), 
          ...
          expr.body.forEach(extract_candidates)) : expr instanceof AST_Unary ? "++" != expr.operator && "--" != expr.operator || candidates.push(hit_stack.slice()) : expr instanceof AST_VarDef && (!expr.value || expr.value instanceof AST_Chain || (candidates.push(hit_stack.slice()), 
          extract_candidates(expr.value)));
          hit_stack.pop();
        }
        function find_stop(node, level, write_only) {
          var parent = scanner.parent(level);
          return parent instanceof AST_Assign ? !write_only || parent.logical || parent.left instanceof AST_PropAccess || lvalues.has(parent.left.name) ? node : find_stop(parent, level + 1, write_only) : parent instanceof AST_Binary ? !write_only || lazy_op.has(parent.operator) && parent.left !== node ? node : find_stop(parent, level + 1, write_only) : parent instanceof AST_Call || parent instanceof AST_Case ? node : parent instanceof AST_Conditional ? write_only && parent.condition === node ? find_stop(parent, level + 1, write_only) : node : parent instanceof AST_Definitions ? find_stop(parent, level + 1, !0) : parent instanceof AST_Exit ? write_only ? find_stop(parent, level + 1, write_only) : node : parent instanceof AST_If ? write_only && parent.condition === node ? find_stop(parent, level + 1, write_only) : node : parent instanceof AST_IterationStatement ? node : parent instanceof AST_Sequence ? find_stop(parent, level + 1, parent.tail_node() !== node) : parent instanceof AST_SimpleStatement ? find_stop(parent, level + 1, !0) : parent instanceof AST_Switch || parent instanceof AST_VarDef ? node : null;
        }
      ...
      function join_object_assignments(defn, body) {
        if (defn instanceof AST_Definitions) {
          ...
          if (def.value instanceof AST_Object) if (body instanceof AST_Assign && !body.logical ? exprs = [ body ] : body instanceof AST_Sequence && (exprs = body.expressions.slice()), 
          exprs) {
            var trimmed = !1;
            do {
              var node = exprs[0];
    ...
    def_reduce_vars(AST_Accessor, (function(tw, descend, compressor) {
      ...
      const finish_walk = () => {
        if (node.logical) return node.left.walk(tw), push(tw), node.right.walk(tw), pop(tw), 
        !0;
      };
      var sym = node.left;
      ...
      return is_modified(compressor, tw, node, value, 0) ? finish_walk() : (def.references.push(sym), 
      node.logical || (eq || (def.chained = !0), def.fixed = eq ? function() {
        return node.right;
      } : function() {
      ...
      }), node.logical ? (mark(tw, def, !1), push(tw), node.right.walk(tw), pop(tw), !0) : (mark(tw, def, !1), 
      node.right.walk(tw), mark(tw, def, !0), mark_escaped(tw, def, sym.scope, node, value, 0, 1), 
      !0));
      ...
      this.expression.walk(tw), this.optional && push(tw);
      for (const arg of this.args) arg.walk(tw);
      return !0;
    })), def_reduce_vars(AST_PropAccess, (function(tw) {
      if (this.optional) return this.expression.walk(tw), push(tw), this.property instanceof AST_Node && this.property.walk(tw), 
      !0;
      ...
      void 0 !== d.fixed && safe_to_read(tw, d) ? d.fixed && ((fixed_value = this.fixed_value()) instanceof AST_Lambda && is_recursive_ref(tw, d) ? d.recursive_refs++ : fixed_value && !compressor.exposed(d) && function(tw, compressor, def) {
    ...
    class Compressor extends TreeWalker {
      constructor(options, {false_by_default = !1, mangle_options = !1}) {
        ...
        this.sequences_limit = 1 == sequences ? 800 : 0 | sequences, this.evaluated_regexps = new Map, 
        this._toplevel = void 0, this.mangle_options = mangle_options;
      }
      option(key) {
      ...
      compress(toplevel) {
        ...
        for (var passes = +this.options.passes || 1, min_count = 1 / 0, stopping = !1, nth_identifier = this.mangle_options && this.mangle_options.nth_identifier || base54, mangle = {
          ie8: this.option("ie8"),
          nth_identifier
        }, pass = 0; pass < passes; pass++) if (this._toplevel.figure_out_scope(mangle), 
        0 === pass && this.option("drop_console") && (this._toplevel = this._toplevel.drop_console()), 
        (pass > 0 || this.option("reduce_vars")) && this._toplevel.reset_opt_flags(this), 
        this._toplevel = this._toplevel.transform(this), passes > 1) {
          let count = 0;
        ...
        return this.option("expression") && this._toplevel.process_expression(!1), toplevel = this._toplevel, 
        this._toplevel = void 0, toplevel;
      }
      before(node, descend) {
    ...
    def_optimize(AST_Node, (function(self) {
      ...
      const self = this, reduce_vars = compressor.option("reduce_vars"), preparation = new TreeWalker((function(node, descend) {
    ...
    function if_break_in_loop(self, compressor) {
      ...
      if (compressor.option("dead_code") && is_break(first)) {
        ...
        return self.init instanceof AST_Statement ? body.push(self.init) : self.init && body.push(make_node(AST_SimpleStatement, self.init, {
          ...
          body: self.condition
        })), trim_unreachable_code(compressor, self.body, body), make_node(AST_BlockStatement, self, {
          body
        });
      }
    ...
    AST_Scope.DEFMETHOD("drop_unused", (function(compressor) {
      ...
      const assign_as_unused = r_keep_assign.test(compressor.option("unused")) ? return_false : function(node) {
        return node instanceof AST_Assign && !node.logical && (has_flag(node, 32) || "=" == node.operator) ? node.left : node instanceof AST_Unary && has_flag(node, 32) ? node.expression : void 0;
      };
      ...
      self.walk(tw), tw = new TreeWalker(scan_ref_scoped), in_use_ids.forEach((function(def) {
      ...
      if (hoist_funs || hoist_vars) {
        ...
        if (self = self.transform(tt), vars_found > 0) {
          ...
          if (vars.forEach(((def, name) => {
            ...
            for (;0 < self.body.length; ) {
              if (self.body[0] instanceof AST_SimpleStatement) {
                var sym, assign, expr = self.body[0].body;
                if (expr instanceof AST_Assign && "=" == expr.operator && (sym = expr.left) instanceof AST_Symbol && vars.has(sym.name)) {
                  ...
                  def.value = expr.right, remove(defs, def), defs.push(def), self.body.splice(0, 1);
                  continue;
                }
                if (expr instanceof AST_Sequence && (assign = expr.expressions[0]) instanceof AST_Assign && "=" == assign.operator && (sym = assign.left) instanceof AST_Symbol && vars.has(sym.name)) {
                  var def;
                  if ((def = vars.get(sym.name)).value) break;
                  def.value = assign.right, remove(defs, def), defs.push(def), self.body[0].body = make_sequence(expr, expr.expressions.slice(1));
                  continue;
                }
              }
              if (self.body[0] instanceof AST_EmptyStatement) self.body.splice(0, 1); else {
                if (!(self.body[0] instanceof AST_BlockStatement)) break;
                self.body.splice(0, 1, ...self.body[0].body);
              }
            }
      ...
      var top_retain = self instanceof AST_Toplevel && compressor.top_retain || return_false, defs_by_id = new Map, hoister = new TreeTransformer((function(node, descend) {
        ...
        if (node instanceof AST_VarDef) {
          const sym = node.name;
          let def, value;
          if (sym.scope === self && 1 != (def = sym.definition()).escaped && !def.assignments && !def.direct_access && !def.single_use && !compressor.exposed(def) && !top_retain(def) && (value = sym.fixed_value()) === node.value && value instanceof AST_Object && !value.properties.some((prop => prop instanceof AST_Expansion || prop.computed_key()))) {
            descend(node, this);
            const defs = new Map, assignments = [];
            return value.properties.forEach((({key, value}) => {
              const scope = find_scope(hoister), symbol = self.create_symbol(sym.CTOR, {
                source: sym,
                scope,
                conflict_scopes: new Set([ scope, ...sym.definition().references.map((ref => ref.scope)) ]),
      ...
      if (compressor.option("side_effects")) {
        ...
        if (!node) return make_node(AST_EmptyStatement, self);
      ...
      self.condition) {
        ...
        !cond)) {
          var body = [];
          return trim_unreachable_code(compressor, self.body, body), self.init instanceof AST_Statement ? body.push(self.init) : self.init && body.push(make_node(AST_SimpleStatement, self.init, {
            body: self.init
      ...
      if (compressor.option("dead_code")) {
        ...
        !cond) {
          var body = [];
          return trim_unreachable_code(compressor, self.body, body), body.push(make_node(AST_SimpleStatement, self.condition, {
            body: self.condition
          })), self.alternative && body.push(self.alternative), make_node(AST_BlockStatement, self, {
            body
          }).optimize(compressor);
        }
        if (!(cond instanceof AST_Node)) return (body = []).push(make_node(AST_SimpleStatement, self.condition, {
          body: self.condition
        })), body.push(self.body), self.alternative && trim_unreachable_code(compressor, self.alternative, body), 
        make_node(AST_BlockStatement, self, {
          body
        }).optimize(compressor);
      }
      ...
      for (let i = 0; i < body.length; i++) {
        let branch = body[i];
        if (0 !== branch.body.length && aborts(branch)) for (let j = i + 1; j < body.length; i++, 
        j++) {
          let next = body[j];
          if (0 !== next.body.length) {
            if (!(branches_equivalent(next, branch, !1) || j === body.length - 1 && branches_equivalent(next, branch, !0))) break;
      ...
      }
      {
        ...
        if (i++, !default_or_exact || body.indexOf(default_or_exact) >= i) for (let j = body.length - 1; j >= i; j--) {
          let branch = body[j];
          if (branch === default_or_exact) default_or_exact = null, body.pop(); else {
      ...
      DEFAULT: if (default_or_exact) {
        ...
        if (default_body_index > side_effect_index) {
          ...
          side_effect_index > default_index ? (after = side_effect_index, body[side_effect_index].body = body[default_body_index].body) : default_or_exact.body = body[default_body_index].body, 
          body.splice(after + 1, default_body_index - after), body.splice(before, default_index - before);
        }
      }
      DEFAULT: if (default_or_exact) {
        ...
        let sideEffect = body.find((branch => branch !== default_or_exact && branch.expression.has_side_effects(compressor)));
        if (!sideEffect) return make_node(AST_BlockStatement, self, {
          body: decl.concat(statement(self.expression), default_or_exact.expression ? statement(default_or_exact.expression) : [], caseBody || [])
        }).optimize(compressor);
        const default_index = body.indexOf(default_or_exact);
        if (body.splice(default_index, 1), default_or_exact = null, caseBody) return make_node(AST_BlockStatement, self, {
          body: decl.concat(self, caseBody)
        }).optimize(compressor);
      }
      if (body.length > 0 && (body[0].body = decl.concat(body[0].body)), 0 == body.length) return make_node(AST_BlockStatement, self, {
        body: decl.concat(statement(self.expression))
      }).optimize(compressor);
      if (1 == body.length && !has_nested_break(self)) {
        let branch = body[0];
      ...
      if (2 === body.length && default_or_exact && !has_nested_break(self)) {
        ...
        if (aborts(body[0])) {
          let first = body[0];
          return is_break(first.body[first.body.length - 1], compressor) && first.body.pop(), 
      ...
      function has_nested_break(root) {
        let has_break = !1, tw = new TreeWalker((node => {
          ...
          if (node instanceof AST_Lambda) return !0;
          if (node instanceof AST_SimpleStatement) return !0;
      ...
      function is_break(node, stack) {
        return node instanceof AST_Break && stack.loopcontrol_target(node) === self;
      }
      ...
      compressor.option("dead_code") && self.body.every(is_empty)) {
        var body = [];
        return self.bcatch && trim_unreachable_code(compressor, self.bcatch, body), self.bfinally && body.push(...self.bfinally.body), 
        make_node(AST_BlockStatement, self, {
          body
        }).optimize(compressor);
      }
      ...
      return self.name instanceof AST_SymbolLet && null != self.value && is_undefined(self.value, compressor) && (self.value = null), 
      self;
      ...
      if (compressor.option("unsafe_Function") && is_undeclared_ref(exp) && "Function" == exp.name) {
        ...
        if (self.args.every((x => x instanceof AST_String))) try {
          var code = "n(function(" + self.args.slice(0, -1).map((function(arg) {
            return arg.value;
          })).join(",") + "){" + self.args[self.args.length - 1].value + "})", ast = parse(code), mangle = {
            ie8: compressor.option("ie8"),
            nth_identifier
          };
          ...
          (ast = ast.transform(comp)).figure_out_scope(mangle), ast.compute_char_frequency(mangle), 
      ...
      var stat = is_func && fn.body[0], is_regular_func = is_func && !fn.is_generator && !fn.async, can_inline = is_regular_func && compressor.option("inline") && !self.is_callee_pure(compressor);
      if (can_inline && stat instanceof AST_Return) {
        ...
        if (1 === fn.argnames.length && fn.argnames[0] instanceof AST_SymbolFunarg && self.args.length < 2 && returned instanceof AST_SymbolRef && returned.name === fn.argnames[0].name) {
          ...
          let parent;
          return replacement instanceof AST_PropAccess && (parent = compressor.parent()) instanceof AST_Call && parent.expression === self ? make_sequence(self, [ make_node(AST_Number, self, {
            value: 0
      ...
      if (can_inline) {
        ...
        }(stat)) && (exp === fn || has_annotation(self, _INLINE) || compressor.option("unused") && 1 == (def = exp.definition()).references.length && !is_recursive_ref(compressor, def) && fn.is_constant_expression(exp.scope)) && !has_annotation(self, _PURE | _NOINLINE) && !fn.contains_this() && function() {
        ...
        make_sequence(self, function(returned_value) {
          ...
          if (function(decls, expressions) {
            ...
            for (i = len; --i >= 0; ) {
              ...
              if (has_flag(name, 1) || !name.name || scope.conflicting_def(name.name)) value && expressions.push(value); else {
      ...
      if (can_inline && has_annotation(self, _INLINE)) return set_flag(fn, 256), (fn = (fn = make_node(fn.CTOR === AST_Defun ? AST_Function : fn.CTOR, fn, fn)).clone(!0)).figure_out_scope({}, {
      ...
      function append_var(decls, expressions, name, value) {
        ...
        scope.variables.has(name.name) || (scope.variables.set(name.name, def), scope.enclosed.push(def), 
      ...
      if ("delete" == self.operator && !(e instanceof AST_SymbolRef || e instanceof AST_PropAccess || e instanceof AST_Chain || is_identifier_atom(e))) return make_sequence(self, [ e, make_node(AST_True, self) ]).optimize(compressor);
    ...
    function is_reachable(self, defs) {
      ...
      return walk_parent(self, ((node, info) => {
        if (node instanceof AST_Scope && node !== self) {
          ...
          if (parent instanceof AST_Call && parent.expression === node && !node.async && !node.is_generator) return;
    ...
    def_optimize(AST_Binary, (function(self, compressor) {
      ...
      if ("+" == self.operator && compressor.in_boolean_context()) {
        ...
        if (ll && "string" == typeof ll) return make_sequence(self, [ self.right, make_node(AST_True, self) ]).optimize(compressor);
        if (rr && "string" == typeof rr) return make_sequence(self, [ self.left, make_node(AST_True, self) ]).optimize(compressor);
      }
      ...
      if (compressor.option("evaluate")) {
        switch (self.operator) {
         case "&&":
          if (!(ll = !!has_flag(self.left, 2) || !has_flag(self.left, 4) && self.left.evaluate(compressor))) return maintain_this_binding(compressor.parent(), compressor.self(), self.left).optimize(compressor);
          if (!(ll instanceof AST_Node)) return make_sequence(self, [ self.left, self.right ]).optimize(compressor);
          if (rr = self.right.evaluate(compressor)) {
            if (!(rr instanceof AST_Node)) {
              if ("&&" == (parent = compressor.parent()).operator && parent.left === compressor.self() || compressor.in_boolean_context()) return self.left.optimize(compressor);
            }
          } else {
            if (compressor.in_boolean_context()) return make_sequence(self, [ self.left, make_node(AST_False, self) ]).optimize(compressor);
            set_flag(self, 4);
          }
         ...
         case "||":
          var parent, lr;
          if (!(ll = !!has_flag(self.left, 2) || !has_flag(self.left, 4) && self.left.evaluate(compressor))) return make_sequence(self, [ self.left, self.right ]).optimize(compressor);
          if (!(ll instanceof AST_Node)) return maintain_this_binding(compressor.parent(), compressor.self(), self.left).optimize(compressor);
          if (rr = self.right.evaluate(compressor)) {
            if (!(rr instanceof AST_Node)) {
              if (compressor.in_boolean_context()) return make_sequence(self, [ self.left, make_node(AST_True, self) ]).optimize(compressor);
              set_flag(self, 2);
            }
          } else if ("||" == (parent = compressor.parent()).operator && parent.left === compressor.self() || compressor.in_boolean_context()) return self.left.optimize(compressor);
         ...
         case "??":
          if (is_nullish(self.left, compressor)) return self.right;
        ...
        switch (self.operator) {
         case "+":
          ...
          if (self.left instanceof AST_TemplateString) {
            var l = self.left;
            if ((r = self.right.evaluate(compressor)) != self.right) return l.segments[l.segments.length - 1].value += String(r), 
            l;
          }
          if (self.right instanceof AST_TemplateString) {
            r = self.right;
            if ((l = self.left.evaluate(compressor)) != self.left) return r.segments[0].value = String(l) + r.segments[0].value, 
            r;
          }
      ...
      }), self.right = self.right.right.transform(compressor), self.transform(compressor);
      var ev = self.evaluate(compressor);
      return ev !== self ? (ev = make_node_from_constant(ev, self).optimize(compressor), 
      best_of(compressor, ev, self)) : self;
      ...
      if (!compressor.option("ie8") && is_undeclared_ref(self) && !compressor.find_parent(AST_With)) switch (self.name) {
       case "undefined":
      ...
      if (compressor.option("reduce_vars") && is_lhs(self, parent) !== self) {
        const def = self.definition(), nearest_scope = find_scope(compressor);
        if (compressor.top_retain && def.global && compressor.top_retain(def)) return def.fixed = !1, 
        def.single_use = !1, self;
        let fixed = self.fixed_value(), single_use = def.single_use && !(parent instanceof AST_Call && parent.is_callee_pure(compressor) || has_annotation(parent, _NOINLINE)) && !(parent instanceof AST_Export && fixed instanceof AST_Lambda && fixed.name);
        if (single_use && fixed instanceof AST_Node && (single_use = !fixed.has_side_effects(compressor) && !fixed.may_throw(compressor)), 
        single_use && (fixed instanceof AST_Lambda || fixed instanceof AST_Class)) if (retain_top_func(fixed, compressor)) single_use = !1; else if (def.scope === self.scope || 1 != def.escaped && !has_flag(fixed, 16) && !function(compressor) {
          ...
          return !1;
        }(compressor) && compressor.option("reduce_funcs")) {
          if (is_recursive_ref(compressor, def)) single_use = !1; else if ((def.scope !== self.scope || def.orig[0] instanceof AST_SymbolFunarg) && (single_use = fixed.is_constant_expression(self.scope), 
          "f" == single_use)) {
        ...
        if (single_use && fixed instanceof AST_Lambda && (single_use = def.scope === self.scope && !scope_encloses_variables_in_this_scope(nearest_scope, fixed) || parent instanceof AST_Call && parent.expression === self && !scope_encloses_variables_in_this_scope(nearest_scope, fixed) && !(fixed.name && fixed.name.definition().recursive_refs > 0)), 
        single_use && fixed) {
          ...
          return (fixed instanceof AST_Lambda || fixed instanceof AST_Class) && fixed.parent_scope !== nearest_scope && (fixed = fixed.clone(!0, compressor.get_toplevel()), 
          nearest_scope.add_child_scope(fixed)), fixed.optimize(compressor);
        }
        if (fixed) {
          let replace;
          if (fixed instanceof AST_This) def.orig[0] instanceof AST_SymbolFunarg || !def.references.every((ref => def.scope === ref.scope)) || (replace = fixed); else {
            var ev = fixed.evaluate(compressor);
            ev === fixed || !compressor.option("unsafe_regexp") && ev instanceof RegExp || (replace = make_node_from_constant(ev, fixed));
          }
          if (replace) {
            const name_length = self.size(compressor), replace_size = replace.size(compressor);
            let overhead = 0;
            if (compressor.option("unused") && !compressor.exposed(def) && (overhead = (name_length + 2 + replace_size) / (def.references.length - def.assignments)), 
            replace_size <= name_length + overhead) return replace;
          }
        }
      }
      return self;
    ...
    function inline_array_like_spread(elements) {
      for (var i = 0; i < elements.length; i++) {
        ...
        if (el instanceof AST_Expansion) {
          ...
          expr instanceof AST_Array && !expr.elements.some((elm => elm instanceof AST_Hole)) && (elements.splice(i, 1, ...expr.elements), 
          i--);
        }
      }
    }
    function lift_key(self, compressor) {
      ...
      if (self.key instanceof AST_String || self.key instanceof AST_Number) {
        ...
        self instanceof AST_ObjectKeyVal ? (self.quote = self.key.quote, self.key = self.key.value) : self instanceof AST_ClassProperty ? (self.quote = self.key.quote, 
        self.key = make_node(AST_SymbolClassProperty, self.key, {
          name: self.key.value
        })) : (self.quote = self.key.quote, self.key = make_node(AST_SymbolMethod, self.key, {
          name: self.key.value
        }));
      }
      return self;
    ...
    def_optimize(AST_Assign, (function(self, compressor) {
      if (self.logical) return self.lift_sequences(compressor);
      var def;
      ...
      var cond = self.condition.evaluate(compressor);
      if (cond !== self.condition) return maintain_this_binding(compressor.parent(), compressor.self(), cond ? self.consequent : self.alternative);
      ...
      if (consequent instanceof AST_Assign && alternative instanceof AST_Assign && consequent.operator === alternative.operator && consequent.logical === alternative.logical && consequent.left.equivalent_to(alternative.left) && (!self.condition.has_side_effects(compressor) || "=" == consequent.operator && !consequent.left.has_side_effects(compressor))) return make_node(AST_Assign, self, {
      ...
      if (compressor.option("ecma") >= 2020 && function(check, check_subject, compressor) {
        ...
        if (check instanceof AST_Binary && "||" === check.operator) {
          ...
          const find_comparison = cmp => {
            ...
            is_undefined(cmp.left, compressor) && (found++, undefined_cmp = cmp, defined_side = cmp.right), 
            is_undefined(cmp.right, compressor) && (found++, undefined_cmp = cmp, defined_side = cmp.left), 
      ...
      make_node(AST_Number, self, {
        value: +self.value
      })) : compressor.option("booleans") ? p instanceof AST_Binary && ("==" == p.operator || "!=" == p.operator) ? make_node(AST_Number, self, {
        value: +self.value
      ...
      if (compressor.option("properties") && "__proto__" !== key) {
        ...
        if (expr instanceof AST_Object) for (var props = expr.properties, i = props.length; --i >= 0; ) {
          ...
          if ("" + (prop instanceof AST_ConciseMethod ? prop.key.name : prop.key) == key) {
            if (!props.every((p => (p instanceof AST_ObjectKeyVal || arrows && p instanceof AST_ConciseMethod && !p.is_generator) && !p.computed_key()))) return;
      ...
      if (is_nullish(self.expression, compressor)) {
        ...
        return parent instanceof AST_UnaryPrefix && "delete" === parent.operator ? make_node_from_constant(0, self) : make_node(AST_Undefined, self);
      }
      return self;
      ...
      return optimized !== self ? optimized : (inline_array_like_spread(self.elements), 
      self);
    })), def_optimize(AST_Object, (function(self, compressor) {
      var optimized = literals_in_boolean_context(self, compressor);
      return optimized !== self ? optimized : (function(props, compressor) {
        for (var i = 0; i < props.length; i++) {
          var prop = props[i];
          if (prop instanceof AST_Expansion) {
            const expr = prop.expression;
            expr instanceof AST_Object && expr.properties.every((prop => prop instanceof AST_ObjectKeyVal)) ? (props.splice(i, 1, ...expr.properties), 
            i--) : (expr instanceof AST_Constant && !(expr instanceof AST_String) || is_nullish(expr, compressor)) && (props.splice(i, 1), 
            i--);
          }
        }
      }(self.properties, compressor), self);
      ...
      if (1 == compressor.option("pure_getters") && compressor.option("unused") && !self.is_array && Array.isArray(self.names) && !function(compressor) {
        ...
        return !0;
      }(compressor) && !(self.names[self.names.length - 1] instanceof AST_Expansion)) {
    ...
    var source_map = __webpack_require__(217);
    ...
    function mangle_properties(ast, options) {
      var nth_identifier = (options = defaults(options, {
        builtins: !1,
        cache: null,
        debug: !1,
        keep_quoted: !1,
    ...
    async function minify(files, options, _fs_module) {
      ...
      var quoted_props, toplevel, code, match, timings = (options = defaults(options, {
        compress: {},
        ecma: void 0,
        enclose: !1,
        ie8: !1,
      ...
      options.output && options.format) throw new Error("Please only specify either output or format option, preferrably format.");
      if (options.format = options.format || options.output || {}, set_shorthand("ecma", options, [ "parse", "compress", "format" ]), 
      set_shorthand("ie8", options, [ "compress", "mangle", "format" ]), set_shorthand("keep_classnames", options, [ "compress", "mangle" ]), 
      set_shorthand("keep_fnames", options, [ "compress", "mangle" ]), set_shorthand("module", options, [ "parse", "compress", "mangle" ]), 
      set_shorthand("safari10", options, [ "mangle", "format" ]), set_shorthand("toplevel", options, [ "compress", "mangle" ]), 
      ...
      options.sourceMap && (options.sourceMap = defaults(options.sourceMap, {
        ...
        root: null,
        url: null
      }, !0)), timings && (timings.parse = Date.now()), files instanceof AST_Toplevel) toplevel = files; else {
        if (("string" == typeof files || options.parse.spidermonkey && !Array.isArray(files)) && (files = [ files ]), 
        ...
        }), null)); else for (var name in delete options.parse.spidermonkey, files) if (HOP(files, name) && (options.parse.filename = name, 
        options.parse.toplevel = parse(files[name], options.parse), options.sourceMap && "inline" == options.sourceMap.content)) {
          ...
          options.sourceMap.content = (code = files[name], match = void 0, (match = /(?:^|[^.])\/\/# sourceMappingURL=data:application\/json(;[\w=-]*)?;base64,([+/0-9A-Za-z]*=*)\s*$/.exec(code)) ? to_ascii(match[2]) : (console.warn("inline source map not found"), 
          null));
        }
      ...
      options.enclose && (toplevel = toplevel.wrap_enclose(options.enclose)), timings && (timings.rename = Date.now()), 
      timings && (timings.compress = Date.now()), options.compress && (toplevel = new Compressor(options.compress, {
        mangle_options: options.mangle
      }).compress(toplevel)), timings && (timings.scope = Date.now()), options.mangle && toplevel.figure_out_scope(options.mangle), 
      timings && (timings.mangle = Date.now()), options.mangle && (toplevel.compute_char_frequency(options.mangle), 
      toplevel.mangle_names(options.mangle), toplevel = function(ast, options) {
        ...
        function mangle_private(name) {
          ...
          return mangled || (mangled = nth_identifier.get(++cprivate), private_cache.set(name, mangled)), 
          mangled;
        }
      }(toplevel, options.mangle)), timings && (timings.properties = Date.now()), options.mangle && options.mangle.properties && (toplevel = mangle_properties(toplevel, options.mangle.properties)), 
      timings && (timings.format = Date.now());
      var result = {};
      if (options.format.ast && (result.ast = toplevel), options.format.spidermonkey && (result.ast = toplevel.to_mozilla_ast()), 
      !HOP(options.format, "code") || options.format.code) {
        if (options.sourceMap && (options.format.source_map = await async function(options) {
          var orig_map;
          options = defaults(options, {
            file: null,
            root: null,
          ...
          var generator = new source_map.SourceMapGenerator({
            file: options.file,
            sourceRoot: options.root
          });
          return options.orig && (orig_map = await new source_map.SourceMapConsumer(options.orig)).sources.forEach((function(source) {
        ...
        if (toplevel.print(stream), result.code = stream.get(), options.sourceMap) if (options.sourceMap.asObject ? result.map = options.format.source_map.get().toJSON() : result.map = options.format.source_map.toString(), 
      ...
      options.format && options.format.source_map && options.format.source_map.destroy(), 
      timings && (timings.end = Date.now(), result.timings = {
        ...
        properties: .001 * (timings.format - timings.properties),
        format: .001 * (timings.end - timings.format),
    ...
    async function run_cli({program, packageJson, fs, path}) {
      ...
      if (program.version(packageJson.name + " " + packageJson.version), program.parseArgv = program.parse, 
      program.parse = void 0, process.argv.includes("ast") ? program.helpInformation = function() {
        ...
        var text = [];
        for (var option in default_options) text.push("--" + ("sourceMap" === option ? "source-map" : option) + " options:"), 
        text.push(format_object(default_options[option])), text.push("");
        return text.join("\n");
      }), program.option("-p, --parse <options>", "Specify parser options.", parse_js()), 
      program.option("-c, --compress [options]", "Enable compressor/specify compressor options.", parse_js()), 
      program.option("-m, --mangle [options]", "Mangle names/specify mangler options.", parse_js()), 
      program.option("--mangle-props [options]", "Mangle properties/specify mangler options.", parse_js()), 
      program.option("-f, --format [options]", "Format options.", parse_js()), program.option("-b, --beautify [options]", "Alias for --format.", parse_js()), 
      ...
      if (program.comments && ("object" != typeof options.format && (options.format = {}), 
      options.format.comments = "string" == typeof program.comments ? "false" != program.comments && program.comments : "some"), 
      ...
      "ast" == program.output && (options.format = {
        ast: !0,
        code: !1
          ...
          try {
            walk(parse(value, {
              ...
              if (node instanceof AST_Assign) {
                ...
                return flag ? options[name] = value : value instanceof AST_Array ? options[name] = value.elements.map(to_string) : value instanceof AST_RegExp ? (value = value.value, 
      ...
      "object" == typeof program.sourceMap && "base" in program.sourceMap && (base = program.sourceMap.base, 
      ...
      filesList ? function simple_glob(glob) {
        ...
        try {
          program.parse && (program.parse.acorn ? files = convert_ast((function(toplevel, name) {
            return __webpack_require__(230).parse(files[name], {
              ecmaVersion: 2018,
              locations: !0,
              program: toplevel,
              sourceFile: name,
        ...
        try {
          ...
          if ("SyntaxError" == ex.name) {
            ...
            if (line || col || (line = lines[ex.line - 2], col = line.length), line) {
              col > 70 && (line = line.slice(col - 70), col = 70), print_error(line.slice(0, 80)), 
              print_error(line.slice(0, col).replace(/\S/g, " ") + "^");
            }
          }
          return ex.defs && (print_error("Supported options:"), print_error(format_object(ex.defs))), 
          void fatal(ex);
        }
        if ("ast" == program.output) options.compress || options.mangle || result.ast.figure_out_scope({}), 
        console.log(JSON.stringify(result.ast, (function(key, value) {
          ...
          if (!skip_keys.has(key) && !(value instanceof AST_Token || value instanceof Map)) {
            if (value instanceof AST_Node) {
              ...
              return value.block_scope && (result.variables = value.block_scope.variables, result.enclosed = value.block_scope.enclosed), 
        ...
        }), 2)); else if ("spidermonkey" == program.output) try {
