(() => {
  var __webpack_modules__ = {
    49557: (module, __unused_webpack_exports, __webpack_require__) => {
      ...
      var transpositions = [ [ "APGL", "AGPL" ], [ "Gpl", "GPL" ], [ "GLP", "GPL" ], [ "APL", "Apache" ], [ "ISD", "ISC" ], [ "GLP", "GPL" ], [ "IST", "ISC" ], [ "Claude", "Clause" ], [ " or later", "+" ], [ " International", "" ], [ "GNU", "GPL" ], [ "GUN", "GPL" ], [ "+", "" ], [ "GNU GPL", "GPL" ], [ "GNU/GPL", "GPL" ], [ "GNU GLP", "GPL" ], [ "GNU General Public License", "GPL" ], [ "Gnu public license", "GPL" ], [ "GNU Public License", "GPL" ], [ "GNU GENERAL PUBLIC LICENSE", "GPL" ], [ "MTI", "MIT" ], [ "Mozilla Public License", "MPL" ], [ "Universal Permissive License", "UPL" ], [ "WTH", "WTF" ], [ "-License", "" ] ], transforms = [ function(argument) {
      ...
      module.exports = function(identifier, options) {
        var upgrade = void 0 === (options = options || {}).upgrade || !!options.upgrade;
        function postprocess(value) {
          return upgrade ? function(value) {
            return -1 !== [ "GPL-1.0", "LGPL-1.0", "AGPL-1.0", "GPL-2.0", "LGPL-2.0", "AGPL-2.0", "LGPL-2.1" ].indexOf(value) ? value + "-only" : -1 !== [ "GPL-1.0+", "GPL-2.0+", "GPL-3.0+", "LGPL-2.0+", "LGPL-2.1+", "LGPL-3.0+", "AGPL-1.0+", "AGPL-3.0+" ].indexOf(value) ? value.replace(/\+$/, "-or-later") : -1 !== [ "GPL-3.0", "LGPL-3.0", "AGPL-3.0" ].indexOf(value) ? value + "-or-later" : value;
          }(value) : value;
        }
        if (!("string" == typeof identifier && 0 !== identifier.trim().length)) throw Error("Invalid argument. Expected non-empty string.");
        if (valid(identifier = identifier.trim())) return postprocess(identifier);
        ...
        }))) || null !== (transformed = validLastResort(identifier)) || null !== (transformed = anyCorrection(identifier, validLastResort)) ? postprocess(transformed) : null;
      };
    },
