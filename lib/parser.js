!function() {
  ...
  var external_ast_namespaceObject = require("./ast"), external_long_namespaceObject = require("./long"), external_long_default = __webpack_require__.n(external_long_namespaceObject);
  ...
  var esm_leb = {
    ...
    decodeInt64: function(encodedBuffer, index) {
      var result = decodeIntBuffer(encodedBuffer, index), value = external_long_default().fromBytesLE(result.value, !1);
    ...
    decodeUInt64: function(encodedBuffer, index) {
      var result = decodeUIntBuffer(encodedBuffer, index), value = external_long_default().fromBytesLE(result.value, !0);
      return free(result.value), {
        value: value,
        nextIndex: result.nextIndex,
        lossy: !1
  ...
  function decoder_decode(ab, opts) {
    var buf = new Uint8Array(ab), getUniqueName = external_ast_namespaceObject.getUniqueNameGenerator(), offset = 0;
    ...
    function parseInstructionBlock(code) {
      for (;;) {
        ...
        "end" === instruction.name) {
          var node = (endLoc = void 0, endLoc = getPosition(), external_ast_namespaceObject.withLoc(external_ast_namespaceObject.instruction(instruction.name), endLoc, _startLoc6));
          code.push(node);
          break;
        }
        var args = [];
        if ("loop" === instruction.name) {
          ...
          var label = external_ast_namespaceObject.withRaw(external_ast_namespaceObject.identifier(getUniqueName("loop")), ""), loopNode = function() {
            var endLoc = getPosition();
            return external_ast_namespaceObject.withLoc(external_ast_namespaceObject.loopInstruction(label, blocktype, instr), endLoc, _startLoc7);
          }();
          ...
          var testIndex = external_ast_namespaceObject.withRaw(external_ast_namespaceObject.identifier(getUniqueName("if")), ""), ifBody = [];
          ...
          var consequentInstr = ifBody.slice(0, elseIndex), alternate = ifBody.slice(elseIndex + 1), testInstrs = [], ifNode = function() {
            var endLoc = getPosition();
            return external_ast_namespaceObject.withLoc(external_ast_namespaceObject.ifInstruction(testIndex, testInstrs, _blocktype, consequentInstr, alternate), endLoc, _startLoc8);
          }();
          ...
          var _label = external_ast_namespaceObject.withRaw(external_ast_namespaceObject.identifier(getUniqueName("block")), ""), blockNode = function() {
            var endLoc = getPosition();
            return external_ast_namespaceObject.withLoc(external_ast_namespaceObject.blockInstruction(_label, _instr2, _blocktype2), endLoc, _startLoc9);
          }();
          ...
          var callNode = function() {
            var endLoc = getPosition();
            return external_ast_namespaceObject.withLoc(external_ast_namespaceObject.callInstruction(external_ast_namespaceObject.indexLiteral(index)), endLoc, _startLoc6);
          }();
          ...
          var _callNode = external_ast_namespaceObject.callIndirectInstruction(external_ast_namespaceObject.signature(signature.params, signature.result), []), flagU32 = readU32(), flag = flagU32.value;
          if (eatBytes(flagU32.nextIndex), 0 !== flag) throw new CompileError("zero flag expected");
          code.push(function() {
            var endLoc = getPosition();
            return external_ast_namespaceObject.withLoc(_callNode, endLoc, _startLoc10);
          ...
          for (var i = 0; i <= indices; i++) {
            ...
            eatBytes(_indexu.nextIndex), dump([ _index ], "index"), args.push(external_ast_namespaceObject.numberLiteralFromRaw(_indexu.value.toString(), "u32"));
          }
          ...
          if ("i32" === instruction.object) {
            ...
            eatBytes(value32.nextIndex), dump([ value ], "i32 value"), args.push(external_ast_namespaceObject.numberLiteralFromRaw(value));
          }
          if ("u32" === instruction.object) {
            var valueu32 = readU32(), _value = valueu32.value;
            eatBytes(valueu32.nextIndex), dump([ _value ], "u32 value"), args.push(external_ast_namespaceObject.numberLiteralFromRaw(_value));
          }
          ...
          if ("f32" === instruction.object) {
            ...
            eatBytes(valuef32.nextIndex), dump([ _value4 ], "f32 value"), args.push(external_ast_namespaceObject.floatLiteral(_value4, valuef32.nan, valuef32.inf, String(_value4)));
          }
          if ("f64" === instruction.object) {
            var valuef64 = readF64(), _value5 = valuef64.value;
            eatBytes(valuef64.nextIndex), dump([ _value5 ], "f64 value"), args.push(external_ast_namespaceObject.floatLiteral(_value5, valuef64.nan, valuef64.inf, String(_value5)));
          }
          ...
          var u32 = readU32();
          eatBytes(u32.nextIndex), dump([ u32.value ], "argument " + _i3), args.push(external_ast_namespaceObject.numberLiteralFromRaw(u32.value));
        }
        if (!1 === instructionAlreadyCreated) if ("string" == typeof instruction.object) {
          var _node3 = function() {
            var endLoc = getPosition();
            return external_ast_namespaceObject.withLoc(external_ast_namespaceObject.objectInstruction(instruction.name, instruction.object, args), endLoc, _startLoc6);
          }();
          code.push(_node3);
        } else {
          var _node4 = function() {
            var endLoc = getPosition();
            return external_ast_namespaceObject.withLoc(external_ast_namespaceObject.instruction(instruction.name, args), endLoc, _startLoc6);
          }();
          code.push(_node4);
        }
      }
    ...
    function parseLimits() {
      ...
      return external_ast_namespaceObject.limit(min, max, shared);
    }
    function parseTableType(index) {
      var name = external_ast_namespaceObject.withRaw(external_ast_namespaceObject.identifier(getUniqueName("table")), String(index)), elementTypeByte = readByte();
      ...
      return external_ast_namespaceObject.table(elementType, limits, name);
    }
    function parseGlobalType() {
      ...
      return external_ast_namespaceObject.globalType(type, globalType);
    }
    function parseNameSectionFunctions() {
      ...
      for (var i = 0; i < numbeOfFunctions; i++) {
        ...
        eatBytes(name.nextIndex), functionNames.push(external_ast_namespaceObject.functionNameMetadata(name.value, index));
      }
    ...
    function parseNameSectionLocals() {
      ...
      for (var i = 0; i < numbeOfFunctions; i++) {
        ...
        for (var _i4 = 0; _i4 < numLocals; _i4++) {
          ...
          var name = readUTF8String();
          eatBytes(name.nextIndex), localNames.push(external_ast_namespaceObject.localNameMetadata(name.value, localIndex, functionIndex));
        }
      }
      return localNames;
    }
    function parseMemoryType(i) {
      var limits = parseLimits();
      return external_ast_namespaceObject.memory(limits, external_ast_namespaceObject.indexLiteral(i));
    }
    function parseStartSection() {
      ...
      external_ast_namespaceObject.withLoc(external_ast_namespaceObject.start(external_ast_namespaceObject.indexLiteral(startFuncIndex)), endLoc, startLoc);
    }
    function parseSection(sectionIndex) {
      ...
      var endLoc, sectionSizeInBytesNode = (endLoc = getPosition(), external_ast_namespaceObject.withLoc(external_ast_namespaceObject.numberLiteralFromRaw(sectionSizeInBytes), endLoc, startLoc));
      switch (sectionId) {
       case esm.sections.type:
        ...
        var _metadata = external_ast_namespaceObject.sectionMetadata("type", startOffset, sectionSizeInBytesNode, function() {
          var endLoc = getPosition();
          return external_ast_namespaceObject.withLoc(external_ast_namespaceObject.numberLiteralFromRaw(numberOfTypes), endLoc, _startLoc13);
          ...
          for (var i = 0; i < numberOfTypes; i++) {
            ...
            var params = parseVec((function(b) {
              ...
              return external_ast_namespaceObject.funcParam(v);
            })), result = parseVec((function(b) {
              return esm.valtypes[b];
            }));
            typeInstructionNodes.push((endLoc = void 0, endLoc = getPosition(), external_ast_namespaceObject.withLoc(external_ast_namespaceObject.typeInstruction(void 0, external_ast_namespaceObject.signature(params, result)), endLoc, _startLoc))), 
       ...
       case esm.sections.table:
        ...
        var _metadata2 = external_ast_namespaceObject.sectionMetadata("table", startOffset, sectionSizeInBytesNode, function() {
          var endLoc = getPosition();
          return external_ast_namespaceObject.withLoc(external_ast_namespaceObject.numberLiteralFromRaw(numberOfTable), endLoc, _startLoc14);
       ...
       case esm.sections.import:
        ...
        var _metadata3 = external_ast_namespaceObject.sectionMetadata("import", startOffset, sectionSizeInBytesNode, function() {
          var endLoc = getPosition();
          return external_ast_namespaceObject.withLoc(external_ast_namespaceObject.numberLiteralFromRaw(numberOfImports), endLoc, _startLoc15);
          ...
          for (var endLoc, imports = [], i = 0; i < numberOfImports; i++) {
            ...
            if ("func" === descrType) {
              ...
              importDescr = external_ast_namespaceObject.funcImportDescr(id, external_ast_namespaceObject.signature(signature.params, signature.result)), 
              state.functionsInModule.push({
                id: external_ast_namespaceObject.identifier(name.value),
                signature: signature,
                isExternal: !0
              });
            } else if ("global" === descrType) {
              importDescr = parseGlobalType();
              var globalNode = external_ast_namespaceObject.global(importDescr, []);
            ...
            imports.push((endLoc = void 0, endLoc = getPosition(), external_ast_namespaceObject.withLoc(external_ast_namespaceObject.moduleImport(moduleName.value, name.value, importDescr), endLoc, _startLoc2)));
          }
          return imports;
        }(numberOfImports);
        return {
       ...
       case esm.sections.func:
        ...
        eatBytes(numberOfFunctionsu32.nextIndex);
        var _metadata4 = external_ast_namespaceObject.sectionMetadata("func", startOffset, sectionSizeInBytesNode, function() {
          var endLoc = getPosition();
          return external_ast_namespaceObject.withLoc(external_ast_namespaceObject.numberLiteralFromRaw(numberOfFunctions), endLoc, _startLoc16);
        }());
        !function(numberOfFunctions) {
          ...
          for (var i = 0; i < numberOfFunctions; i++) {
            ...
            var signature = state.typesInModule[typeindex];
            if (void 0 === signature) throw new CompileError("function signature not found (".concat(typeindex, ")"));
            var id = external_ast_namespaceObject.withRaw(external_ast_namespaceObject.identifier(getUniqueName("func")), "");
            state.functionsInModule.push({
              id: id,
              signature: signature,
              isExternal: !1
       ...
       case esm.sections.export:
        ...
        var _metadata5 = external_ast_namespaceObject.sectionMetadata("export", startOffset, sectionSizeInBytesNode, function() {
          var endLoc = getPosition();
          return external_ast_namespaceObject.withLoc(external_ast_namespaceObject.numberLiteralFromRaw(numberOfExport), endLoc, _startLoc17);
        }());
        !function(numberOfExport) {
          ...
          for (var i = 0; i < numberOfExport; i++) {
            ...
            if ("Func" === esm.exportTypes[typeIndex]) {
              ...
              id = external_ast_namespaceObject.numberLiteralFromRaw(index, String(index)), signature = func.signature;
              ...
              id = external_ast_namespaceObject.numberLiteralFromRaw(index, String(index)), signature = null;
       ...
       case esm.sections.code:
        ...
        var _metadata6 = external_ast_namespaceObject.sectionMetadata("code", startOffset, sectionSizeInBytesNode, function() {
          var endLoc = getPosition();
          return external_ast_namespaceObject.withLoc(external_ast_namespaceObject.numberLiteralFromRaw(numberOfFuncs), endLoc, _startLoc18);
        }());
        if (!0 === opts.ignoreCodeSection) eatBytes(sectionSizeInBytes - _u4.nextIndex); else !function(numberOfFuncs) {
          ...
          for (var i = 0; i < numberOfFuncs; i++) {
            ...
            for (var locals = [], _i = 0; _i < funcLocalNum; _i++) {
              ...
              var valtypeByte = readByte();
              eatBytes(1);
              for (var type = esm.valtypes[valtypeByte], args = [], _i2 = 0; _i2 < localCount; _i2++) args.push(external_ast_namespaceObject.valtypeLiteral(type));
              var localNode = function() {
                var endLoc = getPosition();
                return external_ast_namespaceObject.withLoc(external_ast_namespaceObject.instruction("local", args), endLoc, _startLoc5);
              }();
       ...
       case esm.sections.start:
        ...
        var _metadata7 = external_ast_namespaceObject.sectionMetadata("start", startOffset, sectionSizeInBytesNode);
        return {
       ...
       case esm.sections.element:
        ...
        var _metadata8 = external_ast_namespaceObject.sectionMetadata("element", startOffset, sectionSizeInBytesNode, function() {
          var endLoc = getPosition();
          return external_ast_namespaceObject.withLoc(external_ast_namespaceObject.numberLiteralFromRaw(numberOfElements), endLoc, _startLoc19);
          ...
          for (var i = 0; i < numberOfElements; i++) {
            ...
            for (var indexValues = [], _i5 = 0; _i5 < indices; _i5++) {
              var indexu32 = readU32(), index = indexu32.value;
              eatBytes(indexu32.nextIndex), dump([ index ], "index"), indexValues.push(external_ast_namespaceObject.indexLiteral(index));
            }
            var elemNode = (endLoc = void 0, endLoc = getPosition(), external_ast_namespaceObject.withLoc(external_ast_namespaceObject.elem(external_ast_namespaceObject.indexLiteral(tableindex), instr, indexValues), endLoc, _startLoc12));
            elems.push(elemNode);
          }
          return elems;
        }(numberOfElements);
       ...
       case esm.sections.global:
        ...
        var _metadata9 = external_ast_namespaceObject.sectionMetadata("global", startOffset, sectionSizeInBytesNode, function() {
          var endLoc = getPosition();
          return external_ast_namespaceObject.withLoc(external_ast_namespaceObject.numberLiteralFromRaw(numberOfGlobals), endLoc, _startLoc20);
          ...
          for (var i = 0; i < numberOfGlobals; i++) {
            ...
            var node = (endLoc = void 0, endLoc = getPosition(), external_ast_namespaceObject.withLoc(external_ast_namespaceObject.global(globalType, init), endLoc, _startLoc11));
       ...
       case esm.sections.memory:
        ...
        var _metadata10 = external_ast_namespaceObject.sectionMetadata("memory", startOffset, sectionSizeInBytesNode, function() {
          var endLoc = getPosition();
          return external_ast_namespaceObject.withLoc(external_ast_namespaceObject.numberLiteralFromRaw(_numberOfElements), endLoc, _startLoc21);
       ...
       case esm.sections.data:
        ...
        var _metadata11 = external_ast_namespaceObject.sectionMetadata("data", startOffset, sectionSizeInBytesNode), _startLoc22 = getPosition(), _numberOfElementsu2 = readU32(), _numberOfElements2 = _numberOfElementsu2.value;
        if (eatBytes(_numberOfElementsu2.nextIndex), _metadata11.vectorOfSize = function() {
          var endLoc = getPosition();
          return external_ast_namespaceObject.withLoc(external_ast_namespaceObject.numberLiteralFromRaw(_numberOfElements2), endLoc, _startLoc22);
        ...
        var _nodes11 = function(numberOfElements) {
          ...
          for (var i = 0; i < numberOfElements; i++) {
            ...
            dump([], "init"), dataEntries.push(external_ast_namespaceObject.data(external_ast_namespaceObject.memIndexLiteral(memoryIndex), instrs[0], external_ast_namespaceObject.byteArray(bytes)));
          }
          return dataEntries;
        }(_numberOfElements2);
        return {
       ...
       case esm.sections.custom:
        ...
        var _metadata12 = [ external_ast_namespaceObject.sectionMetadata("custom", startOffset, sectionSizeInBytesNode) ], sectionName = readUTF8String();
        ...
        if ("name" === sectionName.value) {
          ...
          try {
            _metadata12.push(function() {
              var metadata = external_ast_namespaceObject.producersSectionMetadata([]), sectionTypeByte = readVaruint32();
              ...
              for (var fields = {
                ...
                for (var producerI = 0; producerI < valueCount.value; producerI++) {
                  ...
                  eatBytes(producerVersion.nextIndex), fields[fieldName.value].push(external_ast_namespaceObject.producerMetadataVersionedName(producerName.value, producerVersion.value));
                }
    ...
    state.functionsInModule.forEach((function(func) {
      ...
      if (!0 !== func.isExternal) {
        ...
        funcIndex++;
        var funcNode = external_ast_namespaceObject.func(func.id, external_ast_namespaceObject.signature(params, result), body);
        if (!0 === func.isExternal && (funcNode.isExternal = func.isExternal), !1 === opts.ignoreCodeSection) {
          ...
          (funcNode = external_ast_namespaceObject.withLoc(funcNode, endLoc, _startLoc23)).metadata = {
            bodySize: bodySize
          };
        }
      ...
      null != moduleExport.id && moduleFields.push(external_ast_namespaceObject.withLoc(external_ast_namespaceObject.moduleExport(moduleExport.name, external_ast_namespaceObject.moduleExportDescr(moduleExport.type, moduleExport.id)), moduleExport.endLoc, moduleExport.startLoc));
    })), dumpSep("end of program");
    var module = external_ast_namespaceObject.module(null, moduleFields, external_ast_namespaceObject.moduleMetadata(moduleMetadata.sections, moduleMetadata.functionNames, moduleMetadata.localNames, moduleMetadata.producers));
    return external_ast_namespaceObject.program([ module ]);
  }
  ...
  function esm_decode(buf, customOpts) {
    ...
    return !1 === opts.ignoreCustomNameSection && (function(ast) {
      var functionNames = [];
      external_ast_namespaceObject.traverse(ast, {
      ...
      }), 0 !== functionNames.length && external_ast_namespaceObject.traverse(ast, {
        Func: function(_Func) {
          function Func(_x) {
        ...
        ModuleExport: function(_ModuleExport) {
          ...
          if ("Func" === node.descr.exportType) {
            ...
            functionName && (node.descr.id = external_ast_namespaceObject.identifier(functionName.name));
          }
        })),
        ...
        CallInstruction: function(_CallInstruction) {
          ...
          if (functionName) {
            ...
            node.index = external_ast_namespaceObject.identifier(functionName.name), node.numeric = oldValue, 
            delete node.raw;
          }
        }))
      });
      ...
      }), 0 !== localNames.length && external_ast_namespaceObject.traverse(ast, {
