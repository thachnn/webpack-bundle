(() => {
  var __webpack_modules__ = {
    ...
    818: (module, exports, __webpack_require__) => {
      "use strict";
      Object.defineProperty(exports, "__esModule", {
        value: !0
      }), exports.default = void 0;
      var _path = _interopRequireDefault(__webpack_require__(17)), _schemaUtils = __webpack_require__(471), _globby = _interopRequireDefault(__webpack_require__(477)), _serializeJavascript = _interopRequireDefault(__webpack_require__(201)), _normalizePath = _interopRequireDefault(__webpack_require__(171)), _globParent = _interopRequireDefault(__webpack_require__(971)), _fastGlob = _interopRequireDefault(__webpack_require__(330)), _package = {
        version: __webpack_require__(966).i8
      }, _options = _interopRequireDefault(__webpack_require__(780)), _utils = __webpack_require__(795);
              ...
              this.patterns.map(((item, index) => scheduledTasks.push((async () => {
                ...
                if (assets && assets.length > 0) {
                  if (item.transformAll) {
                    ...
                    })}`, eTag = mergedEtag, cacheItem = cache.getItemCache(cacheKeys, eTag);
    ...
    971: (module, __unused_webpack_exports, __webpack_require__) => {
      "use strict";
      var isGlob = __webpack_require__(330)._isGlob, pathPosixDirname = __webpack_require__(17).posix.dirname, isWin32 = "win32" === __webpack_require__(37).platform(), backslash = /\\/g, escaped = /\\([!*?|[\](){}])/g;
