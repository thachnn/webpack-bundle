(() => {
  var __webpack_modules__ = {
    ...
    299: (module, __unused_webpack_exports, __webpack_require__) => {
      const unicode = __webpack_require__(450);
      module.exports = {
    ...
    605: (module, __unused_webpack_exports, __webpack_require__) => {
      "use strict";
      const parseQuery = __webpack_require__(705);
    ...
    532: (module, __unused_webpack_exports, __webpack_require__) => {
      const getOptions = __webpack_require__(605), {validate} = __webpack_require__(471), optionsSchema = {
        type: "object",
        properties: {
          search: {
            anyOf: [ {
      ...
      module.exports = function(config) {
        ...
        for (const optionsIndex in rawOptionsArray) validate(optionsSchema, rawOptionsArray[optionsIndex], {
    ...
    178: (module, __unused_webpack_exports, __webpack_require__) => {
      const getOptionsArray = __webpack_require__(532), replace = __webpack_require__(737);
      module.exports = function(source, map) {
        this.cacheable();
        const optionsArray = getOptionsArray(this);
        let newSource = source;
        for (const options of optionsArray) newSource = replace(newSource, options, this);
    ...
    737: module => {
      module.exports = function(source, options, context) {
        ...
        replace = "function" == typeof options.replace ? options.replace.bind(context) : options.replace, 
