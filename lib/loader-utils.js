module.exports = function(modules) {
  ...
  "use strict";
  const JSON5 = __webpack_require__(6), specialValues = {
    null: null,
    true: !0,
    false: !1
  };
  ...
  module.exports = function(buffer, hashType, digestType, maxLength) {
    ...
    const hash = __webpack_require__(17).createHash(hashType);
    return hash.update(buffer), "base26" === digestType || "base32" === digestType || "base36" === digestType || "base49" === digestType || "base52" === digestType || "base58" === digestType || "base62" === digestType || "base64" === digestType ? function(buffer, base) {
      ...
      const readLength = buffer.length, Big = __webpack_require__(16);
      Big.RM = Big.DP = 0;
      let b = new Big(0);
  ...
  "use strict";
  const getOptions = __webpack_require__(5), parseQuery = __webpack_require__(1), stringifyRequest = __webpack_require__(10), getRemainingRequest = __webpack_require__(11), getCurrentRequest = __webpack_require__(12), isUrlRequest = __webpack_require__(13), urlToRequest = __webpack_require__(14), parseString = __webpack_require__(15), getHashDigest = __webpack_require__(3), interpolateName = __webpack_require__(18);
  ...
  var _parse2 = _interopRequireDefault(__webpack_require__(7)), _stringify2 = _interopRequireDefault(__webpack_require__(9));
  ...
  "use strict";
  const path = __webpack_require__(0), emojisList = __webpack_require__(19), getHashDigest = __webpack_require__(3), emojiRegex = /[\uD800-\uDFFF]./, emojiList = emojisList.filter(emoji => emojiRegex.test(emoji)), emojiCache = {};
