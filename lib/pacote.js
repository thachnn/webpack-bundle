(() => {
  var __webpack_modules__ = {
    ...
    30342: (module, __unused_webpack_exports, __webpack_require__) => {
      "use strict";
      const pkg = __webpack_require__(50066), figgyPudding = __webpack_require__(55212), silentLog = __webpack_require__(63235), AUTH_REGEX = /^(?:.*:)?(token|_authToken|username|_password|password|email|always-auth|_auth|otp)$/, SCOPE_REGISTRY_REGEX = /@.*:registry$/gi;
    ...
    50066: module => {
      "use strict";
      module.exports = JSON.parse('{"name":"npm-registry-fetch","version":"4.0.7","description":"Fetch-based http client for use with npm registry APIs","license":"ISC"}');
    }
