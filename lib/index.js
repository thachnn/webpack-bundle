  ...
  var __webpack_modules__ = {
    4793: module => {
      ...
      class LoaderError extends Error {
        constructor(err) {
          super();
          const {name, message, codeFrame, hideStack} = (err => (err instanceof SyntaxError ? (err.name = "SyntaxError", 
          err.message = err.message.replace(STRIP_FILENAME_RE, ""), err.hideStack = !0) : err instanceof TypeError && (err.name = null, 
          err.message = err.message.replace(STRIP_FILENAME_RE, ""), err.hideStack = !0), err))(err);
          this.name = "BabelLoaderError", this.message = `${name ? `${name}: ` : ""}${message}\n\n${codeFrame}\n`, 
    ...
    8881: (module, __unused_webpack_exports, __webpack_require__) => {
      ...
      const fs = __webpack_require__(7147), os = __webpack_require__(2037), path = __webpack_require__(1017), zlib = __webpack_require__(9796), crypto = __webpack_require__(6113), findCacheDir = __webpack_require__(2512), {promisify} = __webpack_require__(3837), transform = __webpack_require__(3214);
      let defaultCacheDirectory = null, hashType = "md4";
      try {
        crypto.createHash(hashType);
      } catch (err) {
        hashType = "md5";
      }
      const readFile = promisify(fs.readFile), writeFile = promisify(fs.writeFile), gunzip = promisify(zlib.gunzip), gzip = promisify(zlib.gzip), makeDir = __webpack_require__(789), read = function() {
        var _ref = _asyncToGenerator((function*(filename, compress) {
          const data = yield readFile(filename + (compress ? ".gz" : "")), content = compress ? yield gunzip(data) : data;
        ...
        var _ref2 = _asyncToGenerator((function*(filename, compress, result) {
          const content = JSON.stringify(result), data = compress ? yield gzip(content) : content;
        ...
        var _ref3 = _asyncToGenerator((function*(directory, params) {
          const {source, options = {}, cacheIdentifier, cacheDirectory, cacheCompression} = params, file = path.join(directory, function(source, identifier, options) {
            const hash = crypto.createHash(hashType), contents = JSON.stringify({
              source,
              options,
              identifier
            });
            return hash.update(contents), hash.digest("hex") + ".json";
          }(source, cacheIdentifier, options));
          try {
            return yield read(file, cacheCompression);
          } catch (err) {}
          const fallback = "string" != typeof cacheDirectory && directory !== os.tmpdir();
          try {
            yield makeDir(directory);
          } catch (err) {
            if (fallback) return handleCache(os.tmpdir(), params);
            throw err;
          }
      ...
      module.exports = function() {
        var _ref4 = _asyncToGenerator((function*(params) {
          let directory;
          return "string" == typeof params.cacheDirectory ? directory = params.cacheDirectory : (null === defaultCacheDirectory && (defaultCacheDirectory = findCacheDir({
            name: "babel-loader"
          }) || os.tmpdir()), directory = defaultCacheDirectory), yield handleCache(directory, params);
        }));
        return function(_x8) {
    ...
    8101: (module, __unused_webpack_exports, __webpack_require__) => {
      "use strict";
      const babel = __webpack_require__(4629);
      let supportsCallerOptionFlag;
      module.exports = function(opts, target) {
        return function() {
          if (void 0 === supportsCallerOptionFlag) try {
            babel.loadPartialConfig({
              caller: void 0,
              babelrc: !1,
              configFile: !1
            }), supportsCallerOptionFlag = !0;
          } catch (err) {
            supportsCallerOptionFlag = !1;
          }
          ...
          caller: Object.assign({
            ...
            supportsTopLevelAwait: !0
          }, opts.caller)
        }) : opts;
      };
    },
    3214: (module, __unused_webpack_exports, __webpack_require__) => {
      "use strict";
      function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {
        try {
          var info = gen[key](arg), value = info.value;
      ...
      const babel = __webpack_require__(4629), {promisify} = __webpack_require__(3837), LoaderError = __webpack_require__(4793), transform = promisify(babel.transform);
      module.exports = function() {
        var fn, _ref = (fn = function*(source, options) {
          let result;
          try {
          ...
          return !map || map.sourcesContent && map.sourcesContent.length || (map.sourcesContent = [ source ]), 
          {
            ast,
            code,
            map,
    ...
    4194: (module, __unused_webpack_exports, __webpack_require__) => {
      const util = __webpack_require__(8299);
      let source, parseState, stack, pos, line, column, token, key, root, lexState, buffer, doubleQuote, sign, c;
    ...
    8299: (module, __unused_webpack_exports, __webpack_require__) => {
      const unicode = __webpack_require__(1450);
      module.exports = {
    ...
    4605: (module, __unused_webpack_exports, __webpack_require__) => {
      "use strict";
      const parseQuery = __webpack_require__(3110);
      module.exports = function(loaderContext) {
        const query = loaderContext.query;
        return "string" == typeof query && "" !== query ? parseQuery(loaderContext.query) : query && "object" == typeof query ? query : {};
      };
    },
    789: (module, __unused_webpack_exports, __webpack_require__) => {
      "use strict";
      const fs = __webpack_require__(7147), path = __webpack_require__(1017), {promisify} = __webpack_require__(3837), useNativeRecursiveOption = __webpack_require__(747).satisfies(process.version, ">=10.12.0"), checkPath = pth => {
    ...
    2619: (module, __unused_webpack_exports, __webpack_require__) => {
      ...
      let babel;
      try {
        babel = __webpack_require__(4629);
      } catch (err) {
        throw "MODULE_NOT_FOUND" === err.code && (err.message += "\n babel-loader@8 requires Babel 7.x (the package '@babel/core'). If you'd like to use Babel 6.x ('babel-core'), you should install 'babel-loader@7'."), 
        err;
      }
      ...
      const version = __webpack_require__(3034).i8, cache = __webpack_require__(8881), transform = __webpack_require__(3214), injectCaller = __webpack_require__(8101), schema = __webpack_require__(9548), {isAbsolute} = __webpack_require__(1017), loaderUtils = {
        getOptions: __webpack_require__(4605)
      }, validateOptions = __webpack_require__(3842);
      function subscribe(subscriber, metadata, context) {
        context[subscriber] && context[subscriber](metadata);
      }
      function makeLoader(callback) {
        const overrides = callback ? callback(babel) : void 0;
      ...
      function _loader() {
        return (_loader = _asyncToGenerator((function*(source, inputSourceMap, overrides) {
          const filename = this.resourcePath;
          let customOptions, loaderOptions = loaderUtils.getOptions(this);
          if (validateOptions(schema, loaderOptions, {
            name: "Babel loader"
          }), null != loaderOptions.customize) {
            if ("string" != typeof loaderOptions.customize) throw new Error("Customized loaders must be implemented as standalone modules.");
            if (!isAbsolute(loaderOptions.customize)) throw new Error("Customized loaders must be passed as absolute paths, since babel-loader has no way to know what they would be relative to.");
            if (overrides) throw new Error("babel-loader's 'customize' option is not available when already using a customized babel-loader wrapper.");
            let override = require(loaderOptions.customize);
            if (override.__esModule && (override = override.default), "function" != typeof override) throw new Error("Custom overrides must be functions.");
          ...
          if (overrides && overrides.customOptions) {
            ...
            customOptions = result.custom, loaderOptions = result.loader;
          }
          "forceEnv" in loaderOptions && console.warn("The option `forceEnv` has been removed in favor of `envName` in Babel 7."), 
          "string" == typeof loaderOptions.babelrc && console.warn("The option `babelrc` should not be set to a string anymore in the babel-loader config. Please update your configuration and set `babelrc` to true or false.\nIf you want to specify a specific babel config file to inherit config from please use the `extends` option.\nFor more information about this options see https://babeljs.io/docs/core-packages/#options"), 
          Object.prototype.hasOwnProperty.call(loaderOptions, "sourceMap") && !Object.prototype.hasOwnProperty.call(loaderOptions, "sourceMaps") && (loaderOptions = Object.assign({}, loaderOptions, {
            sourceMaps: loaderOptions.sourceMap
          }), delete loaderOptions.sourceMap);
          const programmaticOptions = Object.assign({}, loaderOptions, {
            filename,
            inputSourceMap: inputSourceMap || loaderOptions.inputSourceMap,
            sourceMaps: void 0 === loaderOptions.sourceMaps ? this.sourceMap : loaderOptions.sourceMaps,
            sourceFileName: filename
          });
          if (delete programmaticOptions.customize, delete programmaticOptions.cacheDirectory, 
          delete programmaticOptions.cacheIdentifier, delete programmaticOptions.cacheCompression, 
          delete programmaticOptions.metadataSubscribers, !babel.loadPartialConfig) throw new Error(`babel-loader ^8.0.0-beta.3 requires @babel/core@7.0.0-beta.41, but you appear to be using "${babel.version}". Either update your @babel/core version, or pin you babel-loader version to 8.0.0-beta.2`);
          const {loadPartialConfigAsync = babel.loadPartialConfig} = babel, config = yield loadPartialConfigAsync(injectCaller(programmaticOptions, this.target));
          if (config) {
            let options = config.options;
            overrides && overrides.config && (options = yield overrides.config.call(this, config, {
              source,
              map: inputSourceMap,
              customOptions
            })), "inline" === options.sourceMaps && (options.sourceMaps = !0);
            const {cacheDirectory = null, cacheIdentifier = JSON.stringify({
              options,
              "@babel/core": transform.version,
              "@babel/loader": version
            }), cacheCompression = !0, metadataSubscribers = []} = loaderOptions;
            let result;
            if (result = cacheDirectory ? yield cache({
              source,
              options,
              transform,
              cacheDirectory,
              cacheIdentifier,
              cacheCompression
            }) : yield transform(source, options), config.files ? config.files.forEach((configFile => this.addDependency(configFile))) : ("string" == typeof config.babelrc && this.addDependency(config.babelrc), 
            config.config && this.addDependency(config.config)), result) {
              overrides && overrides.result && (result = yield overrides.result.call(this, result, {
                source,
                map: inputSourceMap,
                customOptions,
                config,
              ...
              return metadataSubscribers.forEach((subscriber => {
      ...
      module.exports = makeLoader(), module.exports.custom = makeLoader;
    },
    3110: (module, __unused_webpack_exports, __webpack_require__) => {
      "use strict";
      const JSON5 = {
        parse: __webpack_require__(4194)
      }, specialValues = {
        null: null,
        true: !0,
        false: !1
