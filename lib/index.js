(() => {
  var __webpack_modules__ = {
    610: (__unused_webpack_module, exports) => {
      "use strict";
    ...
    962: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      __webpack_require__.r(__webpack_exports__), __webpack_require__.d(__webpack_exports__, {
        DOUBLE_PRECISION_MANTISSA: () => DOUBLE_PRECISION_MANTISSA,
        NUMBER_OF_BYTE_F32: () => NUMBER_OF_BYTE_F32,
        NUMBER_OF_BYTE_F64: () => NUMBER_OF_BYTE_F64,
        SINGLE_PRECISION_MANTISSA: () => SINGLE_PRECISION_MANTISSA,
        decodeF32: () => decodeF32,
        decodeF64: () => decodeF64,
        encodeF32: () => encodeF32,
        encodeF64: () => encodeF64
    ...
    687: (__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      "use strict";
      __webpack_require__.r(__webpack_exports__), __webpack_require__.d(__webpack_exports__, {
        MAX_NUMBER_OF_BYTE_U32: () => MAX_NUMBER_OF_BYTE_U32,
        MAX_NUMBER_OF_BYTE_U64: () => MAX_NUMBER_OF_BYTE_U64,
        decodeInt32: () => esm_decodeInt32,
        decodeInt64: () => esm_decodeInt64,
        decodeUInt32: () => esm_decodeUInt32,
        decodeUInt64: () => esm_decodeUInt64,
        encodeI32: () => encodeI32,
        encodeI64: () => encodeI64,
        encodeU32: () => encodeU32
      });
      ...
      var MAX_NUMBER_OF_BYTE_U32 = 5, MAX_NUMBER_OF_BYTE_U64 = 10;
  ...
  (() => {
    ...
    __webpack_require__.r(__webpack_exports__), __webpack_require__.d(__webpack_exports__, {
      add: () => add,
      addWithAST: () => addWithAST,
      edit: () => edit,
      editWithAST: () => editWithAST
    });
    const wasm_parser_namespaceObject = require("@webassemblyjs/wasm-parser"), ast_namespaceObject = require("@webassemblyjs/ast");
    var clone = __webpack_require__(610), encoder = __webpack_require__(391);
    ...
    function shrinkPaddedLEB128(ast, uint8Buffer) {
      return (0, ast_namespaceObject.traverse)(ast, {
        SectionMetadata: function(_ref2) {
          ...
          if (newu32EncodedLen !== oldu32EncodedLen) {
            ...
            uint8Buffer = overrideBytesInBuffer(uint8Buffer, start, end, newu32Encoded), function(ast, _ref, deltaInSizeEncoding) {
              ...
              (0, ast_namespaceObject.traverse)(ast, {
                SectionMetadata: function(path) {
                  path.node.section !== section ? !0 === encounteredSection && (0, ast_namespaceObject.shiftSection)(ast, path.node, deltaInSizeEncoding) : encounteredSection = !0;
                }
              });
    ...
    function createEmptySection(ast, uint8Buffer, section) {
      ...
      var sizeStartLoc = {
        ...
        line: -1,
        column: start + 1
      }, size = ast_namespaceObject.withLoc(ast_namespaceObject.numberLiteralFromRaw(1), sizeEndLoc, sizeStartLoc), vectorOfSizeStartLoc = {
        line: -1,
        column: sizeEndLoc.column
      }, vectorOfSizeEndLoc = {
        line: -1,
        column: sizeEndLoc.column + 1
      }, vectorOfSize = ast_namespaceObject.withLoc(ast_namespaceObject.numberLiteralFromRaw(0), vectorOfSizeEndLoc, vectorOfSizeStartLoc), sectionMetadata = ast_namespaceObject.sectionMetadata(section, start, size, vectorOfSize), sectionBytes = encodeNode(sectionMetadata);
      ...
      ast_namespaceObject.sortSectionMetadata(ast.body[0]));
      var deltaBytes = +sectionBytes.length, encounteredSection = !1;
      return ast_namespaceObject.traverse(ast, {
        SectionMetadata: function(path) {
          path.node.section !== section ? !0 === encounteredSection && ast_namespaceObject.shiftSection(ast, path.node, deltaBytes) : encounteredSection = !0;
        }
      }), {
        uint8Buffer,
        sectionMetadata
    ...
    function shiftLocNodeByDelta(node, delta) {
      (0, ast_namespaceObject.assertHasLoc)(node), node.loc.start.column += delta, node.loc.end.column += delta;
    }
    function applyDelete(ast, uint8Buffer, node) {
      if ((0, ast_namespaceObject.assertHasLoc)(node), "start" === (0, esm.getSectionForNode)(node)) {
        var sectionMetadata = (0, ast_namespaceObject.getSectionMetadata)(ast, "start");
        return uint8Buffer = function(ast, uint8Buffer, section) {
          var sectionMetadatas = (0, ast_namespaceObject.getSectionMetadatas)(ast, section);
          ...
          return sectionMetadatas.reverse().reduce((function(uint8Buffer, sectionMetadata) {
            ...
            return (0, ast_namespaceObject.traverse)(ast, {
              SectionMetadata: function(path) {
                ...
                !0 === encounteredSection && (0, ast_namespaceObject.shiftSection)(ast, path.node, delta);
              }
      ...
      return ops.forEach((function(op) {
        ...
        switch (op.kind) {
         case "update":
          state = function(ast, uint8Buffer, _ref) {
            ...
            (0, ast_namespaceObject.assertHasLoc)(oldNode);
            ...
            "code" === sectionName && (0, ast_namespaceObject.traverse)(ast, {
              Func: function(_ref3) {
                var node = _ref3.node;
                if (!0 == (void 0 !== node.body.find((function(n) {
                  return n === newNode;
                })))) {
                  (0, ast_namespaceObject.assertHasLoc)(node);
         ...
         case "add":
          state = function(ast, uint8Buffer, node) {
            ...
            ast_namespaceObject.getSectionMetadata)(ast, sectionName);
            ...
            if ((0, ast_namespaceObject.isFunc)(node) && (0 === (body = node.body).length || "end" !== body[body.length - 1].id)) throw new Error("expressions must be ended");
            if ((0, ast_namespaceObject.isGlobal)(node) && (0 === (body = node.init).length || "end" !== body[body.length - 1].id)) throw new Error("expressions must be ended");
            var newByteArray = encodeNode(node), start = (0, ast_namespaceObject.getEndOfSection)(sectionMetadata), end = start, deltaBytes = newByteArray.length;
            ...
            return "IndexInFuncSection" !== node.type && (0, ast_namespaceObject.orderedInsertNode)(ast.body[0], node), 
            {
              uint8Buffer,
              deltaBytes,
              deltaElements: 1
        ...
        if (0 !== state.deltaElements && "start" !== sectionName) {
          ...
          state.uint8Buffer = function(ast, uint8Buffer, section, deltaElements) {
            var sectionMetadata = (0, ast_namespaceObject.getSectionMetadata)(ast, section);
        ...
        if (0 !== state.deltaBytes && "start" !== sectionName) {
          ...
          state.uint8Buffer = function(ast, uint8Buffer, section, deltaBytes) {
            ...
            return (0, ast_namespaceObject.traverse)(ast, {
              SectionMetadata: function(path) {
                path.node.section !== section ? !0 === encounteredSection && (0, ast_namespaceObject.shiftSection)(ast, path.node, deltaBytes) : encounteredSection = !0;
              }
            }), overrideBytesInBuffer(uint8Buffer, start, end, newBytes);
    ...
    function preprocess(ab) {
      return function(uint8Buffer) {
        try {
          return shrinkPaddedLEB128((0, wasm_parser_namespaceObject.decode)(uint8Buffer.buffer, decoderOpts), uint8Buffer);
        } catch (e) {
    ...
    function edit(ab, visitors) {
      return ab = preprocess(ab), editWithAST((0, wasm_parser_namespaceObject.decode)(ab), ab, visitors);
    }
    function editWithAST(ast, ab, visitors) {
      var nodeBefore, operations = [], uint8Buffer = new Uint8Array(ab);
      return (0, ast_namespaceObject.traverse)(ast, visitors, (function(type, path) {
    ...
    function add(ab, newNodes) {
      return ab = preprocess(ab), addWithAST((0, wasm_parser_namespaceObject.decode)(ab), ab, newNodes);
    }
