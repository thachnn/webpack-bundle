(() => {
  var __webpack_modules__ = {
    ...
    84535: (module, __unused_webpack_exports, __webpack_require__) => {
      "use strict";
      const Y = __webpack_require__(99213);
    ...
    49775: (module, __unused_webpack_exports, __webpack_require__) => {
      ...
      function spawn(cmd, args, opts) {
        return (opts = opts || {}).shell = opts.shell || "win32" === process.platform, new Promise(((resolve, reject) => {
          ...
          child.stdout && child.stdout.on("data", (d => {
            ...
            if (code) {
              const err = new Error(__webpack_require__(99213)`Command failed: ${cmd} ${args.join(" ")}`);
      ...
      module.exports.runCommand = function(command, opts) {
        ...
        return spawn(cmd, copts, {
          ...
          throw "ENOENT" === err.code ? (err = new Error(`npx: ${__webpack_require__(99213)`command not found: ${path.basename(cmd)}`}`)).exitCode = 127 : err.message = __webpack_require__(99213)`Command failed: ${cmd} ${err.message}`, 
          err;
        }));
    ...
    82735: (module, __unused_webpack_exports, __webpack_require__) => {
      ...
      var _y;
      function Y() {
        return _y || (_y = __webpack_require__(99213)), _y;
      }
    ...
    99119: (module, __unused_webpack_exports, __webpack_require__) => {
      ...
      module.exports = function(yargs, y18n) {
        ...
        self.help = function() {
          ...
          acc)), {}));
          const theWrap = getWrap(), ui = __webpack_require__(6910)({
            width: theWrap,
            wrap: !!theWrap
          });
    ...
    87248: (module, __unused_webpack_exports, __webpack_require__) => {
      ...
      function findNodeScript(existing, opts) {
        return existing ? promisify(fs.stat)(existing).then((stat => {
          ...
          if (opts && opts.isLocal && stat.isDirectory()) try {
            const pkg = require(path.resolve(existing, "package.json")), target = path.resolve(existing, pkg.bin || pkg.main || "index.js");
      ...
      function Y() {
        return __webpack_require__(99213);
      }
    ...
    11518: (module, __unused_webpack_exports, __webpack_require__) => {
      "use strict";
      const yargs = __webpack_require__(57205);
    ...
    57205: (module, exports, __webpack_require__) => {
      "use strict";
      ...
      (module.exports = function(processArgs, cwd, parentRequire) {
        ...
        function pkgUp(rootPath) {
          ...
          let obj = {};
          try {
            let startDir = rootPath || __webpack_require__(39228)(parentRequire || require);
    ...
    99213: (module, __unused_webpack_exports, __webpack_require__) => {
      "use strict";
    ...
    6910: (module, __unused_webpack_exports, __webpack_require__) => {
      var stringWidth = __webpack_require__(33038), stripAnsi = __webpack_require__(42600), wrap = __webpack_require__(7063), align = {
    ...
    7063: (module, __unused_webpack_exports, __webpack_require__) => {
      "use strict";
