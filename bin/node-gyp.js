...
require("../vendor/v8-compile-cache"), (() => {
  ...
  var __webpack_modules__ = {
    633: (module, __unused_webpack_exports, __webpack_require__) => {
      const path = __webpack_require__(17), os = __webpack_require__(37), homedir = os.homedir(), tmpdir = os.tmpdir(), {env} = process, envPaths = (name, options) => {
        if ("string" != typeof name) throw new TypeError("Expected string, got " + typeof name);
        return (options = Object.assign({
          ...
          const appData = env.APPDATA || path.join(homedir, "AppData", "Roaming"), localAppData = env.LOCALAPPDATA || path.join(homedir, "AppData", "Local");
          return {
  ...
  (() => {
    ...
    const envPaths = __webpack_require__(633), gyp = __webpack_require__(421), log = __webpack_require__(334), os = __webpack_require__(37), prog = gyp();
    var completed = !1;
