module.exports = function(modules) {
  ...
  121: function(module, exports, __webpack_require__) {
    var ClientRequest = __webpack_require__(122), response = __webpack_require__(62), extend = __webpack_require__(124), statusCodes = __webpack_require__(125), url = __webpack_require__(127), http = exports;
  ...
  122: function(module, exports, __webpack_require__) {
    var capability = __webpack_require__(61), inherits = __webpack_require__(0), response = __webpack_require__(62), stream = __webpack_require__(19), toArrayBuffer = __webpack_require__(123), IncomingMessage = response.IncomingMessage, rStates = response.readyStates;
  ...
  125: function(module, exports, __webpack_require__) {
    "use strict";
    module.exports = __webpack_require__(126).STATUS_CODES;
  },
  ...
  13: function(module, exports, __webpack_require__) {
    ...
    }, Stream = __webpack_require__(14), Buffer = __webpack_require__(1).Buffer, OurUint8Array = global.Uint8Array || function() {};
    var realHasInstance, destroyImpl = __webpack_require__(15);
    function nop() {}
    function WritableState(options, stream) {
      Duplex = Duplex || __webpack_require__(3), options = options || {};
  ...
  17: function(module, exports, __webpack_require__) {
    ...
    var Duplex, isArray = __webpack_require__(18);
    Readable.ReadableState = ReadableState;
    __webpack_require__(21).EventEmitter;
    var EElistenerCount = function(emitter, type) {
      return emitter.listeners(type).length;
    }, Stream = __webpack_require__(14), Buffer = __webpack_require__(1).Buffer, OurUint8Array = global.Uint8Array || function() {};
    var util = Object.create(__webpack_require__(5));
    util.inherits = __webpack_require__(0);
    var debugUtil = __webpack_require__(2), debug = void 0;
    debug = debugUtil && debugUtil.debuglog ? debugUtil.debuglog("stream") : function() {};
    var StringDecoder, BufferList = __webpack_require__(23), destroyImpl = __webpack_require__(15);
    util.inherits(Readable, Stream);
    var kProxyEvents = [ "error", "close", "destroy", "pause", "resume" ];
    function ReadableState(options, stream) {
      options = options || {};
      var isDuplex = stream instanceof (Duplex = Duplex || __webpack_require__(3));
      ...
      this.readingMore = !1, this.decoder = null, this.encoding = null, options.encoding && (StringDecoder || (StringDecoder = __webpack_require__(10).StringDecoder), 
    ...
    Readable.prototype._destroy = function(err, cb) {
      ...
      return StringDecoder || (StringDecoder = __webpack_require__(10).StringDecoder), 
  ...
  19: function(module, exports, __webpack_require__) {
    ...
    exports.Stream = Stream) : ((exports = module.exports = __webpack_require__(17)).Stream = Stream || exports, 
    exports.Readable = exports, exports.Writable = __webpack_require__(13), exports.Duplex = __webpack_require__(3), 
    exports.Transform = __webpack_require__(22), exports.PassThrough = __webpack_require__(28));
  },
  ...
  22: function(module, exports, __webpack_require__) {
    ...
    var Duplex = __webpack_require__(3), util = Object.create(__webpack_require__(5));
    ...
    util.inherits = __webpack_require__(0), util.inherits(Transform, Duplex), Transform.prototype.push = function(chunk, encoding) {
  ...
  23: function(module, exports, __webpack_require__) {
    "use strict";
    var Buffer = __webpack_require__(1).Buffer, util = __webpack_require__(2);
    module.exports = function() {
      function BufferList() {
  ...
  28: function(module, exports, __webpack_require__) {
    ...
    var Transform = __webpack_require__(22), util = Object.create(__webpack_require__(5));
    function PassThrough(options) {
      if (!(this instanceof PassThrough)) return new PassThrough(options);
      Transform.call(this, options);
    }
    util.inherits = __webpack_require__(0), util.inherits(PassThrough, Transform), PassThrough.prototype._transform = function(chunk, encoding, cb) {
      cb(null, chunk);
    };
  },
  3: function(module, exports, __webpack_require__) {
    "use strict";
    var pna = __webpack_require__(6), objectKeys = Object.keys || function(obj) {
      var keys = [];
    ...
    var util = Object.create(__webpack_require__(5));
    util.inherits = __webpack_require__(0);
    var Readable = __webpack_require__(17), Writable = __webpack_require__(13);
  ...
  62: function(module, exports, __webpack_require__) {
    var capability = __webpack_require__(61), inherits = __webpack_require__(0), stream = __webpack_require__(19), rStates = exports.readyStates = {
      UNSENT: 0,
      OPENED: 1,
      HEADERS_RECEIVED: 2,
      LOADING: 3,
