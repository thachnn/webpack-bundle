(() => {
  ...
  var __webpack_modules__ = {
    37: (module, exports, __webpack_require__) => {
      exports.__esModule = !0, exports.default = void 0;
      var obj, _esutils = (obj = __webpack_require__(3178)) && obj.__esModule ? obj : {
        default: obj
      };
      exports.default = ({types: t}) => {
        function convertAttributesAssign(attributes) {
          const args = [];
          for (let current, i = 0; i < attributes.length; i++) {
            const node = attributes[i];
            if (t.isJSXSpreadAttribute(node)) 0 === i && args.push(t.objectExpression([])), 
            current = null, args.push(node.argument); else {
              const name = getAttributeName(node), value = getAttributeValue(node);
              current || (current = t.objectExpression([]), args.push(current)), current.properties.push(t.objectProperty(name, value));
            }
          }
        ...
        function convertAttributeSpread(node) {
          if (t.isJSXSpreadAttribute(node)) return t.spreadElement(node.argument);
          const name = getAttributeName(node), value = getAttributeValue(node);
          return t.inherits(t.objectProperty(name, value), node);
        }
        function getAttributeName(node) {
          return t.isJSXNamespacedName(node.name) ? t.stringLiteral(node.name.namespace.name + ":" + node.name.name.name) : _esutils.default.keyword.isIdentifierNameES6(node.name.name) ? t.identifier(node.name.name) : t.stringLiteral(node.name.name);
        }
        function getAttributeValue(node) {
          let value = node.value || t.booleanLiteral(!0);
          return t.isJSXExpressionContainer(value) ? value = value.expression : t.isStringLiteral(value) && (value.value = value.value.replace(/\n\s+/g, " "), 
          value.extra && value.extra.raw && delete value.extra.raw), value;
        }
        return {
          name: "transform-jsx-spread",
          visitor: {
            JSXOpeningElement(path, state) {
              const useSpread = !0 === state.opts.useSpread;
              path.node.attributes.some((attr => t.isJSXSpreadAttribute(attr))) && 1 !== path.node.attributes.length && (path.node.attributes = useSpread ? [ t.jsxSpreadAttribute(t.objectExpression(path.node.attributes.map(convertAttributeSpread))) ] : [ t.jsxSpreadAttribute(convertAttributesAssign(path.node.attributes)) ]);
            }
          }
        };
    ...
    4630: module => {
      ...
      module.exports = {
        ...
        isStatement,
        isIterationStatement: function(node) {
          if (null == node) return !1;
          switch (node.type) {
           case "DoWhileStatement":
           case "ForInStatement":
        ...
        isSourceElement: function(node) {
          return isStatement(node) || null != node && "FunctionDeclaration" === node.type;
        },
        isProblematicIfStatement: function(node) {
          var current;
    ...
    4787: module => {
      ...
      IDENTIFIER_START = new Array(128), ch = 0; ch < 128; ++ch) IDENTIFIER_START[ch] = ch >= 97 && ch <= 122 || ch >= 65 && ch <= 90 || 36 === ch || 95 === ch;
      ...
      module.exports = {
        ...
        isWhiteSpace: function(ch) {
          return 32 === ch || 9 === ch || 11 === ch || 12 === ch || 160 === ch || ch >= 5760 && NON_ASCII_WHITESPACES.indexOf(ch) >= 0;
        },
    ...
    359: (module, __unused_webpack_exports, __webpack_require__) => {
      ...
      module.exports = {
        ...
        isIdentifierNameES5,
        isIdentifierNameES6,
        isIdentifierES5: function(id, strict) {
          return isIdentifierNameES5(id) && !isReservedWordES5(id, strict);
        },
        isIdentifierES6: function(id, strict) {
          return isIdentifierNameES6(id) && !isReservedWordES6(id, strict);
        }
      };
    },
    3178: (__unused_webpack_module, exports, __webpack_require__) => {
      exports.ast = __webpack_require__(4630), exports.code = __webpack_require__(4787), 
      exports.keyword = __webpack_require__(359);
    }
  ...
  var __webpack_exports__ = function __webpack_require__(moduleId) {
    ...
    module.exports;
  }(37), __webpack_export_target__ = exports;
