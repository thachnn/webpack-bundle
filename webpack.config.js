...
module.exports = [
  ...
  webpackConfig('browserslist', {
      ...
      rules: [
        {
          ...
          loader: 'webpack/lib/replace-loader',
          options: { search: /\brequire(?=\(\w+|\.resolve\b)/g, replace: 'require("originalRequire")' },
        },
        {
    ...
    plugins: [
      ...
      new ReplaceCodePlugin({ search: ' require("./originalRequire")', replace: ' require', test: /index\.js$/ }),
    ],
    optimization: {
