(() => {
  var __webpack_modules__ = {
    ...
    57: (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      const path = __webpack_require__(1017), globParent = __webpack_require__(7647), micromatch = __webpack_require__(8341), COMMON_GLOB_SYMBOLS_RE = /[*?]|^!/, REGEX_CHARACTER_CLASS_SYMBOLS_RE = /\[[^[]*]/, REGEX_GROUP_SYMBOLS_RE = /(?:^|[^!*+?@])\([^(]*\|[^|]*\)/, GLOB_EXTENSION_SYMBOLS_RE = /[!*+?@]\([^(]*\)/, BRACE_EXPANSION_SEPARATORS_RE = /,|\.\./;
